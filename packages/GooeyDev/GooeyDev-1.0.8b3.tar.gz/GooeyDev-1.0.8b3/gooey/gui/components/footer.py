...
class Footer(wx.Panel):
    ...
    def _init_components(self):
        ...
        #self.print_cmd_button = self.button(_("Print command"), wx.ID_OK, event_id=int(events.WINDOW_CMD))
        self.progress_bar = wx.Gauge(self, range=100)

        self.time_remaining_text = wx.StaticText(self)

        self.buttons = [self.cancel_button, self.start_button, #self.print_cmd_button,
    ...
    def _do_layout(self):
        ...
        #h_sizer.Add(self.print_cmd_button, 0, wx.RIGHT, 20)
