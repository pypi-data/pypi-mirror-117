...
class APIV1Api(object):
    ...
    def cli_experiment_freeze_dataset_version_api(self, dataset_id, experiment_id, **kwargs):  # noqa: E501
        ...
        :param cli_experiment_freeze_dataset_version_api_payload:
        :type cli_experiment_freeze_dataset_version_api_payload: CliExperimentFreezeDatasetVersionAPIPayload
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def cli_experiment_freeze_dataset_version_api_with_http_info(self, dataset_id, experiment_id, **kwargs):  # noqa: E501
        ...
        all_params = [
            'dataset_id',
            'experiment_id',
            'cli_experiment_freeze_dataset_version_api_payload'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        body_params = None
        if 'cli_experiment_freeze_dataset_version_api_payload' in local_var_params:
            body_params = local_var_params['cli_experiment_freeze_dataset_version_api_payload']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def cli_git_hub_token_api(self, **kwargs):  # noqa: E501
        """cli_git_hub_token_api  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.cli_git_hub_token_api(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ExternalCliGitHubTokenResponse
        """
        kwargs['_return_http_data_only'] = True
        return self.cli_git_hub_token_api_with_http_info(**kwargs)  # noqa: E501

    def cli_git_hub_token_api_with_http_info(self, **kwargs):  # noqa: E501
        """cli_git_hub_token_api  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.cli_git_hub_token_api_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ExternalCliGitHubTokenResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method cli_git_hub_token_api" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        response_types_map = {
            200: "ExternalCliGitHubTokenResponse",
        }

        return self.api_client.call_api(
            '/api/v1/github/token', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def cli_workspace_backup_api(self, workspace_id, **kwargs):  # noqa: E501
        """cli_workspace_backup_api  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.cli_workspace_backup_api(workspace_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: WorkspaceCliWorkspaceBackupResponse
        """
        kwargs['_return_http_data_only'] = True
        return self.cli_workspace_backup_api_with_http_info(workspace_id, **kwargs)  # noqa: E501

    def cli_workspace_backup_api_with_http_info(self, workspace_id, **kwargs):  # noqa: E501
        """cli_workspace_backup_api  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.cli_workspace_backup_api_with_http_info(workspace_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(WorkspaceCliWorkspaceBackupResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method cli_workspace_backup_api" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('workspace_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `workspace_id` when calling `cli_workspace_backup_api`")  # noqa: E501
        ...
        response_types_map = {
            200: "WorkspaceCliWorkspaceBackupResponse",
        }
    ...
    def dataset_version_create_api(self, dataset_id, **kwargs):  # noqa: E501
        ...
        :param dataset_id: (required)
        :type dataset_id: int
        :param dataset_version_create_api_payload:
        :type dataset_version_create_api_payload: DatasetVersionCreateAPIPayload
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def dataset_version_create_api_with_http_info(self, dataset_id, **kwargs):  # noqa: E501
        ...
        all_params = [
            'dataset_id',
            'dataset_version_create_api_payload'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        body_params = None
        if 'dataset_version_create_api_payload' in local_var_params:
            body_params = local_var_params['dataset_version_create_api_payload']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def dataset_version_read_api_with_http_info(self, dataset_id, dataset_version_hash, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('dataset_version_hash' not in local_var_params or  # noqa: E501
                                                        local_var_params['dataset_version_hash'] is None):  # noqa: E501
    ...
    def dataset_version_update_api(self, dataset_id, dataset_version_hash, **kwargs):  # noqa: E501
        ...
        :param dataset_version_hash: (required)
        :type dataset_version_hash: str
        :param dataset_version_update_api_payload:
        :type dataset_version_update_api_payload: DatasetVersionUpdateAPIPayload
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def dataset_version_update_api_with_http_info(self, dataset_id, dataset_version_hash, **kwargs):  # noqa: E501
        ...
        all_params = [
            'dataset_id',
            'dataset_version_hash',
            'dataset_version_update_api_payload'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        body_params = None
        if 'dataset_version_update_api_payload' in local_var_params:
            body_params = local_var_params['dataset_version_update_api_payload']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def s_sh_key_create_api(self, **kwargs):  # noqa: E501
        ...
        :param ssh_key_create_api_payload:
        :type ssh_key_create_api_payload: SSHKeyCreateAPIPayload
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def s_sh_key_create_api_with_http_info(self, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'ssh_key_create_api_payload' in local_var_params:
            body_params = local_var_params['ssh_key_create_api_payload']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def s_sh_key_delete_api_with_http_info(self, ssh_key_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ssh_key_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['ssh_key_id'] is None):  # noqa: E501
    ...
    def sweep_create_api(self, organization_name, project_name, **kwargs):  # noqa: E501
        ...
        :param project_name: (required)
        :type project_name: str
        :param sweep_create_api_payload:
        :type sweep_create_api_payload: SweepCreateAPIPayload
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def sweep_create_api_with_http_info(self, organization_name, project_name, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'sweep_create_api_payload' in local_var_params:
            body_params = local_var_params['sweep_create_api_payload']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def sweep_delete_api_with_http_info(self, organization_name, project_name, sweep, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('sweep' not in local_var_params or  # noqa: E501
                                                        local_var_params['sweep'] is None):  # noqa: E501
    ...
    def workspace_list_api_with_http_info(self, organization_name, **kwargs):  # noqa: E501
        ...
        if 'limit' in local_var_params and local_var_params['limit'] is not None:  # noqa: E501
            query_params.append(('limit', local_var_params['limit']))  # noqa: E501
        if 'mine' in local_var_params and local_var_params['mine'] is not None:  # noqa: E501
