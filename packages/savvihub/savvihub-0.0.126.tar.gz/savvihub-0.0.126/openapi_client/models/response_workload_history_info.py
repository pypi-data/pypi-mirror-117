...
class ResponseWorkloadHistoryInfo(object):
    ...
    def __init__(self, created_dt=None, ended_timestamp=None, id=None, immutable_slug=None, message=None, started_timestamp=None, status=None, updated_dt=None, workload_history_workload=None, workload_id=None, local_vars_configuration=None):  # noqa: E501
