...
class ResponseExperimentInfo(object):
    ...
    def __init__(self, access_token_id=None, cli_driven_project=None, created_by=None, created_by_id=None, created_dt=None, endpoints=None, env_vars=None, exit_code=None, experiment_plot_volume=None, experiment_workload=None, final_cost=None, histories=None, id=None, immutable_slug=None, kernel_cluster=None, kernel_cluster_id=None, kernel_cluster_node=None, kernel_cluster_node_id=None, kernel_cluster_select_policies=None, kernel_image=None, kernel_image_id=None, kernel_resource_spec=None, kernel_resource_spec_id=None, message=None, metrics_summary=None, name=None, number=None, organization=None, organization_id=None, project=None, project_id=None, reproduce_command=None, slug=None, source_code_link=None, start_command=None, status=None, status_last_updated=None, status_reason=None, sweep_id=None, termination_protection=None, type=None, updated_dt=None, version_control_project=None, volume_mounts=None, workload_access_token=None, workload_created_by=None, workload_kernel_cluster=None, workload_kernel_cluster_node=None, workload_kernel_image=None, workload_kernel_resource_spec=None, workload_organization=None, workload_project=None, workload_sweep=None, local_vars_configuration=None):  # noqa: E501
