...
class GoogleApi():
    ...
    def __init__(self, credentials: str, token: str = None, service_account: str = False, debug=False):
    ...
    def get_service(self, name):
        ...
        if self.service_account:
            http = self.__authenticate_using_service_account()
            return discovery.build(
                api_service, api_version, http=http)
