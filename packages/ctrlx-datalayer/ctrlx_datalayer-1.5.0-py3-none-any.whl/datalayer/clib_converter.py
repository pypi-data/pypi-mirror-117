...
datalayer.clib.libcomm_datalayer.DLR_converterGenerateJsonSimple.argtypes = (
    void_p_converter, variant_p_data, variant_p_json, int32_indentStep)
datalayer.clib.libcomm_datalayer.DLR_converterGenerateJsonSimple.restype = C_DLR_RESULT
...
datalayer.clib.libcomm_datalayer.DLR_converterGenerateJsonComplex.argtypes = (
    void_p_converter, variant_p_data, variant_p_json, int32_indentStep)
datalayer.clib.libcomm_datalayer.DLR_converterGenerateJsonComplex.restype = C_DLR_RESULT
...
datalayer.clib.libcomm_datalayer.DLR_converterParseJsonSimple.argtypes = (
    void_p_converter, variant_p_json, variant_p_error)
datalayer.clib.libcomm_datalayer.DLR_converterParseJsonSimple.restype = C_DLR_RESULT
...
datalayer.clib.libcomm_datalayer.DLR_converterParseJsonComplex.argtypes = (
    void_p_converter, variant_p_json, variant_p_type, variant_p_data, variant_p_error)
datalayer.clib.libcomm_datalayer.DLR_converterParseJsonComplex.restype = C_DLR_RESULT


# DLR_RESULT DLR_converterGetSchema(DLR_CONVERTER converter, DLR_SCHEMA schema, DLR_VARIANT data);
datalayer.clib.libcomm_datalayer.DLR_converterGetSchema.argtypes = (
    void_p_converter, ctypes.c_uint32, variant_p_data)
datalayer.clib.libcomm_datalayer.DLR_converterGetSchema.restype = C_DLR_RESULT
