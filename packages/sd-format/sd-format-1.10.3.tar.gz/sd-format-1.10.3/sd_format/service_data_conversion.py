...
version = '2021.08.17-p[3.8]dr-01.010.000'  # year.month.day-version_type-major.minor.patch
            ...
            for main_key in source_dictionary:
                ...
                if source_dictionary[main_key] == '':
                    ...
                    if '\n' in source_dictionary[main_key]:
                        ...
                        self.file.write("'''\n\n")
                    elif ' ' in source_dictionary[main_key] or ',' in source_dictionary[main_key]:
                        main_key_row = main_key + '='
                        main_key_row += ' """' + source_dictionary[main_key] + '"""'
