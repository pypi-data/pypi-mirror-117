...
#         return self.__deserialize(items_fond, "list[OPSummaryItem]")[0]
    ...
    def create_item(self, vault_id: str, item: Item):
        ...
        self._create_item_field(encoded_item, serialized_body['fields'], serialized_body['templateUuid'])
    ...
    def _create_item_field(self, encoded_item: dict, fields: dict, template_uuid: str):
        logger.debug(f'{inspect.stack()[0][3]} : start')
        encoded_item['fields'] = []
