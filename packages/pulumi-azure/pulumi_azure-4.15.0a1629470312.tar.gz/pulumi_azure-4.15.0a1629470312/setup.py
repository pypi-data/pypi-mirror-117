...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.15.0-alpha.1629470312+3eed9dc8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.15.0-alpha.1629470312+3eed9dc8`
                """)
            else:
                raise
