...
class InfraEnv(object):
    ...
    def __init__(self, kind=None, id=None, href=None, openshift_version=None, name=None, proxy=None, additional_ntp_sources=None, ssh_authorized_key=None, pull_secret_set=None, static_network_config=None, type=None, ignition_config_override=None, cluster_id=None, size_bytes=None, download_url=None, generator_version=None, updated_at=None, created_at=None, expires_at=None):  # noqa: E501
