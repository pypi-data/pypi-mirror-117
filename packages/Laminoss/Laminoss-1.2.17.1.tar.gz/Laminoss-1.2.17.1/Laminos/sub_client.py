...
headers.sid = laminos.client.Client().sid
...
class VCHeaders:
    def __init__(self, data = None):
        vc_headers = {
            ...
            "User-Agent": "Amino/33553, Chrome/92.0.4515.159 Mobile Safari/537.36",  # New server, fixed old serverization
...
class SubClient(laminos.client.Client):
    def __init__(self, comId: str = None, aminoId: str = None, *, profile: objects.UserProfile):
        ...
        if aminoId is not None:
            self.comId = laminos.client.Client().search_community(aminoId).comId[0]
