...
def test_corn():
    ...
    tea = module.corn_tea
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.03334613925257765, rtol=1e-2)
    assert np.allclose(feedstock.price, 0.13227735731092652, rtol=1e-2)
    assert np.allclose(product.price, 0.48547915353569393, rtol=1e-2)
    assert np.allclose(tea.sales, 73909866.22750998, rtol=1e-2)
    assert np.allclose(tea.material_cost, 54229443.77929443, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 68044856.30432542, rtol=1e-2)
    assert np.allclose(tea.utility_cost, 8671296.449793711, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 138.1526868191502, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 138.97638931681118, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 2.3181240311942704, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 0.0, rtol=1e-2)
    bst.process_tools.default()
...
def test_lipidcane():
    ...
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.20830200377801641, rtol=1e-2)
    assert np.allclose(feedstock.price, 0.03455, rtol=1e-2)
    assert np.allclose(product.price, 0.789, rtol=1e-2)
    assert np.allclose(tea.sales, 108715831.5261424, rtol=1e-2)
    assert np.allclose(tea.material_cost, 59023490.16028184, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 237546755.57913777, rtol=1e-2)
    assert np.allclose(tea.utility_cost, -33232368.133699864, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 263.4431488098409, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 279.32361230956496, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 16.396821830390394, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 122.1623641691014, rtol=1e-2)
    bst.process_tools.default()
...
def test_cornstover():
    ...
    assert np.allclose(product.price, 0.7120290494567719, rtol=1e-2)
    assert np.allclose(tea.sales, 131132955.21732788, rtol=1e-2)
    assert np.allclose(tea.material_cost, 82494108.65163341, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 213406537.82937592, rtol=1e-2)
    assert np.allclose(tea.utility_cost, -12302176.999496555, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 308.166435638137, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 298.2514520952427, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 21.39031453925792, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 46.965017791103776, rtol=1e-2)
    bst.process_tools.default()
...
def test_sugarcane():
    ...
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.12306655887927774, rtol=1e-2)
    assert np.allclose(feedstock.price, 0.03455, rtol=1e-2)
    assert np.allclose(product.price, 0.789, rtol=1e-2)
    assert np.allclose(tea.sales, 88129976.57499589, rtol=1e-2)
    assert np.allclose(tea.material_cost, 59842158.86682246, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 203593325.87360784, rtol=1e-2)
    assert np.allclose(tea.utility_cost, -17939130.85555613, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 300.1061745291436, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 301.00876964589224, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 15.766729446193386, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 72.6655823111072, rtol=1e-2)
    bst.process_tools.default()
...
def test_LAOs():
    ...
    assert np.allclose(product.price, 1.3147917111739813, rtol=1e-2)
    assert np.allclose(tea.sales, 159808673.38908717, rtol=1e-2)
    assert np.allclose(tea.material_cost, 135657144.3782437, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 56585356.15997587, rtol=1e-2)
    ...
    assert np.allclose(units.get_electricity_production(), 7.253112843006863, rtol=1e-2)
    bst.process_tools.default()
