...
def cowboefit(**kwargs):
    ...
    def pmfarea(gfile, gfile2, savefile) :
        ...
        plt.plot(x_y_curve1[:,0],x_y_curve1[:,1],c='b',lw=1,marker='+',markevery=cowboe_settings['mark every'],markersize=5,label="%s"%c1)
        plt.plot(x_y_curve2[:,0],x_y_curve2[:,1],c='k',lw=1,marker='^',markevery=cowboe_settings['mark every'],markersize=5,label="%s"%c2)      
