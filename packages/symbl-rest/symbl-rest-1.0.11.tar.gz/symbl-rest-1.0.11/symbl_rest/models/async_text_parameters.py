...
class AsyncTextParameters(object):
    ...
    def __init__(self, messages=None, entities=None, detect_phrases=None, enable_all_trackers=None, confidence_threshold=None, name=None, trackers=None):  # noqa: E501
