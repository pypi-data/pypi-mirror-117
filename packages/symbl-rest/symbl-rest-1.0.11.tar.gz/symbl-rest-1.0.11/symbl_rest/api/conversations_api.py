...
class ConversationsApi(object):
    ...
    def delete_conversation_by_conversation_id(self, conversation_id, **kwargs):  # noqa: E501
        """deletes conversation and all related entities  # noqa: E501

        deletes conversation and all related entities such as messages, insights, topics etc. associated with the Conversation ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_conversation_by_conversation_id(conversation_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.delete_conversation_by_conversation_id_with_http_info(conversation_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_conversation_by_conversation_id_with_http_info(conversation_id, **kwargs)  # noqa: E501
            return data

    def delete_conversation_by_conversation_id_with_http_info(self, conversation_id, **kwargs):  # noqa: E501
        """deletes conversation and all related entities  # noqa: E501

        deletes conversation and all related entities such as messages, insights, topics etc. associated with the Conversation ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_conversation_by_conversation_id_with_http_info(conversation_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_conversation_by_conversation_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('conversation_id' not in params or
            ...
            raise ValueError("Missing the required parameter `conversation_id` when calling `delete_conversation_by_conversation_id`")  # noqa: E501
    ...
    def get_formatted_transcript_by_conversation_id(self, body, content_type, conversation_id, **kwargs):  # noqa: E501
        """Returns a formatted transcript in Markdown and SRT format.  # noqa: E501

        This API returns a formatted transcript in Markdown and SRT format.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_formatted_transcript_by_conversation_id(body, content_type, conversation_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Body body: null (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_formatted_transcript_by_conversation_id_with_http_info(body, content_type, conversation_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_formatted_transcript_by_conversation_id_with_http_info(body, content_type, conversation_id, **kwargs)  # noqa: E501
            return data

    def get_formatted_transcript_by_conversation_id_with_http_info(self, body, content_type, conversation_id, **kwargs):  # noqa: E501
        """Returns a formatted transcript in Markdown and SRT format.  # noqa: E501

        This API returns a formatted transcript in Markdown and SRT format.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_formatted_transcript_by_conversation_id_with_http_info(body, content_type, conversation_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_formatted_transcript_by_conversation_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `get_formatted_transcript_by_conversation_id`")  # noqa: E501
        # verify the required parameter 'content_type' is set
        if ('content_type' not in params or
                params['content_type'] is None):
            raise ValueError("Missing the required parameter `content_type` when calling `get_formatted_transcript_by_conversation_id`")  # noqa: E501
        # verify the required parameter 'conversation_id' is set
        if ('conversation_id' not in params or
                params['conversation_id'] is None):
            raise ValueError("Missing the required parameter `conversation_id` when calling `get_formatted_transcript_by_conversation_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/conversations/{conversationId}/transcript', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='FormattedTranscriptResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
