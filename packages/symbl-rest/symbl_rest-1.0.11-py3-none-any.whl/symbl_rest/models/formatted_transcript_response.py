...
class FormattedTranscriptResponse(object):
    ...
    def __init__(self, transcript=None):  # noqa: E501
        """FormattedTranscriptResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def transcript(self):
        """Gets the transcript of this FormattedTranscriptResponse.  # noqa: E501


        :return: The transcript of this FormattedTranscriptResponse.  # noqa: E501
        :rtype: FormattedTranscript
        """
        return self._transcript

    @transcript.setter
    def transcript(self, transcript):
        """Sets the transcript of this FormattedTranscriptResponse.


        :param transcript: The transcript of this FormattedTranscriptResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FormattedTranscriptResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FormattedTranscriptResponse):
            return False
