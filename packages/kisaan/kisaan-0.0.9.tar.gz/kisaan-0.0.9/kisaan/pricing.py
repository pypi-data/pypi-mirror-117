...
"""
def calculate_product_price(unit,unit_price,weight):
    unit=str(unit)
...
"""
def calculate_delivery_charges_in_total_amount(cluster_id,delivery_charges,pricing_details,client):
    try:
...
def calculate_pricing_of_cart_products(cart_data):
