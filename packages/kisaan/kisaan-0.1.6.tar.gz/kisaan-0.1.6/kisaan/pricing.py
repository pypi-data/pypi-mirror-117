...
"""
async def calculate_delivery_charges_in_total_amount(cluster_id,delivery_charge,pricing_details,client):
    try:
...
async def calculate_pricing_of_cart_products(products):
    products=products
    total_amount=0
    one_time_amount=0
