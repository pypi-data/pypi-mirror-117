...
class BitmexOrder:
    def __init__(self, symbols, client, settings, settings_path, magic='algo-trader'):
        ...
        for symbol in symbols:
            self.props[symbol] = {
                'stoploss_id': '', 'entry': .0, 'SL': .0, 'TP': .0, 'open': False, 'wait_stop': False, 'qty': 0}
