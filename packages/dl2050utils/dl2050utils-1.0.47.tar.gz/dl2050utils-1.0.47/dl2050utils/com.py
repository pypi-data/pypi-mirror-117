...
# SendGrid
def send_mail(api_key, to, subject=' ', msg=None, html=None, files=[]):
    html2 = html or msg
...
def send_mail_async(api_key, to, subject=' ', msg=None, html=None, files=[]):
...
class Notify():
    ...
    def __call__(self, how, who, subject=' ', msg=None, html=None, files=[]):
    ...
    def send_mail_async(self, to, subject=' ', msg=None, html=None, files=[]):
        send_mail_async(self.api_key, to, subject=subject, msg=msg, html=html, files=files)
    
    def send_mail(self, to, subject=' ', msg=None, html=None, files=[]):
