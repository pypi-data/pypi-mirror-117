...
@pytest.fixture(name="host_storage_hostnames")
def host_storage_hostnames_fixture(docker_compose):
...
@pytest.fixture(name="host_instance")
...
@pytest.fixture(name="ursula_graphql_client")
