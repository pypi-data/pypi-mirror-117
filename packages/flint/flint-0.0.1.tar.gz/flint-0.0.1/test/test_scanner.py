...
class Test(unittest.TestCase):
    ...
    def test_string_continue(self):
        for (line, toks) in zip(self.str_continue_str, self.str_continue):
            test_toks = self.scanner.parse(line)
