...
class Reporter(object):
    ...
    def __init__(self, hostname_alias, log_level, log_file_path, max_transactions, max_flush_wait_time, events_flush_interval, max_request_size_bytes, reporter, host, service_key, trusted_path, buffer_size, trace_metrics, histogram_precision, token_bucket_capacity, token_bucket_rate, file_single, ec2_metadata_timeout, grpc_proxy, stdout_clear_nonblocking, is_grpc_clean_hack_enabled):
