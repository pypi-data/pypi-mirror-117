...
API_GW = "https://86iu7tieha.execute-api.us-east-2.amazonaws.com/api/"
...
def create_training_job(local_train_data, local_test_data, entry_point, inputs_folder, hyper_param:dict):
