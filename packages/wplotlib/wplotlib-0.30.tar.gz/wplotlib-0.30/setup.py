...
setup(
  ...
  #long_description='A simplified plot library for Chieh',
  ...
  download_url = 'https://github.com/endsley/wPlotLib/archive/refs/tags/0.30.tar.gz',    # I explain this later on
