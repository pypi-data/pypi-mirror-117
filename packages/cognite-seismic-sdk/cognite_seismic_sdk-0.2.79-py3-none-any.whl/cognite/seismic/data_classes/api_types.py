...
if not os.getenv("READ_THE_DOCS"):
    ...
    from cognite.seismic.protos.types_pb2 import (
        P6Transformation as P6TransformationProto,
        DoubleTraceCoordinates as DoubleTraceCoordinatesProto,
        DeduceFromTraces as DeduceFromTracesProto,
        SurveyGridTransformation as SurveyGridTransformationProto,
        TraceCorners,
    )
