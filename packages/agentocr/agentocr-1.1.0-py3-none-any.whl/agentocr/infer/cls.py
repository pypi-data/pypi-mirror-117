...
class TextClassifier(object):
    def __init__(self, args):
        ...
        self.session, self.input_names, self.output_names = create_session(args, 'cls', logger)
    ...
    def __call__(self, img_list):
        ...
        for beg_img_no in range(0, img_num, batch_num):
            ...
            prob_out = self.session.run(self.output_names, {self.input_names[0]: norm_img_batch})[0]
