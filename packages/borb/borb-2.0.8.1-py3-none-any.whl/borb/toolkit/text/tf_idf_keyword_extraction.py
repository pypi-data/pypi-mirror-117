...
class TFIDFKeywordExtraction(SimpleTextExtraction):
    ...
    def __init__(
        ...
        super().__init__()
        self._term_frequency_per_page: typing.Dict[int, typing.Dict[str, int]] = {}
        self._number_of_words_per_page: typing.Dict[int, int] = {}
        self._inverse_page_frequency: typing.Dict[str, int] = {}
        self._stopwords: typing.List[str] = [x.upper() for x in stopwords]
        self._number_of_pages: int = 0
        self._minimum_term_frequency: int = minimum_term_frequency
