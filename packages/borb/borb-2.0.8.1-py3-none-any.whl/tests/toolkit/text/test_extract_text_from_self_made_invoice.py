...
class TestExtractTextFromSelfMadeInvoice(unittest.TestCase):
    ...
    def _build_billing_and_shipping_information(self) -> Table:
        ...
        table_001.add(Paragraph("BILL TO", background_color=HexColor("263238"), font_color=X11Color("White"),))
        table_001.add(Paragraph("SHIP TO", background_color=HexColor("263238"), font_color=X11Color("White"),))
    ...
    def test_extract_text(self):
        ...
        # check text
        assert l1.get_text_for_page(0) == "SHIP TO\n[Recipient Name]\n[Company Name]\n[Street Address]\n[City, State, ZIP Code]\n[Phone]"
