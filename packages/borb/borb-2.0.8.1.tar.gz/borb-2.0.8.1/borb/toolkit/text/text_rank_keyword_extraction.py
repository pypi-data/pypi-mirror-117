...
class TextRankKeywordExtraction(SimpleTextExtraction):
    ...
    def __init__(self):
        ...
        self._part_of_speech_tagger: BigramPartOfSpeechTagger = BigramPartOfSpeechTagger()
        bigram_tagger_file: Path = Path(__file__).parent / "bigram_part_of_speech_tagger_en.json"
    ...
    def _end_page(self, page: Page):
        ...
        # extract text
        txt: str = super(TextRankKeywordExtraction, self).get_text_for_page(self._current_page)
        ...
        for line in lines:
            ...
            # POS tagging
            tags_and_tokens: typing.List[typing.Tuple[str, str]] = self._part_of_speech_tagger.tag_str(line)
