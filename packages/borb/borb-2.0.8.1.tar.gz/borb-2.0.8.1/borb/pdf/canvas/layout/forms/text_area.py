...
class TextArea(FormField):
    ...
    def _init_widget_dictionary(self, page: Page, layout_box: Rectangle) -> None:
        ...
        # widget dictionary
        # fmt: off
        self._widget_dictionary: Dictionary = Dictionary()
        ...
        self._widget_dictionary[Name("Rect")] = List().set_can_be_referenced(False)
    ...
    def _do_layout_without_padding(
        ...
        self._widget_dictionary["AP"]["N"]["BBox"][3] = bDecimal(
            self._font_size * self._number_of_lines
        )
