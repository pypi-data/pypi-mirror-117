...
class TestPartOfSpeechTagger(unittest.TestCase):
    ...
    def test_part_of_speech_tagger_001(self):
        ...
        # tag
        toks: typing.List[str] = ["A", "big", "yellow","taxi", "took", "my", "girl", "away", "."]
    ...
    def test_part_of_speech_tagger_002(self):
        ...
        # tag
        toks: typing.List[str] = ["Pity", "the", "living", ",", "and", ",", "above", "all", "those", "who", "live", "without", "love","."]
        tags: typing.List[str] = t.tag_list_str(toks)
        assert tags == ['vb', 'at', 'nn', ',', 'cc', ',', 'in', 'abn', 'dts', 'wps', 'vb', 'in', 'nn', '.']
    ...
    def test_part_of_speech_tagger_003(self):
        ...
        # tag
        tokens_and_tags: typing.List[typing.Tuple[str, str]] = t.tag_str("Pity the living, and, above all those who live without love.")
