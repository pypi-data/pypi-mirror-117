...
class TestWriteTextField(unittest.TestCase):
    ...
    def test_write_text_field_at_absolute_position(self):
        ...
        tf.layout(page, Rectangle(Decimal(59), Decimal(670), Decimal(476), Decimal(12.5)))
    ...
    def test_check_acroform_value(self):
        ...
        doc.get_page(0).set_form_value("Field 1", "Lipsum")

        assert doc.get_page(0).get_form_value("Field 1") == "Lipsum"
