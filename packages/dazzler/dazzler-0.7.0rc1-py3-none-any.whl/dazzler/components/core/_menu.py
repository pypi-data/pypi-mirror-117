...
class Menu(Component):
    ...
    preset_color = Aspect(docstring="Preset color to apply to the font. (Possible values: 'primary', 'secondary', 'danger', 'warning', 'success')")  # noqa: E501
    preset_background = Aspect(docstring="Preset color to apply to the background. (Possible values: 'primary', 'secondary', 'danger', 'warning', 'success')")  # noqa: E501
    ...
    def __init__(
            ...
            hover: typing.Optional[str] = UNDEFINED,
        ...
        :param preset_background: Preset color to apply to the background.
            (Possible values: 'primary', 'secondary', 'danger', 'warning',
            'success')
