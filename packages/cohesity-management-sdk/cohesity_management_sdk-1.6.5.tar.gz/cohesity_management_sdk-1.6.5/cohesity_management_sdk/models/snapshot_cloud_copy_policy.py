...
class SnapshotCloudCopyPolicy(object):
    ...
    _names = {
        ...
        "datalock_config":'datalock_config',
    ...
    def from_dictionary(cls,
        ...
        datalock_config = cohesity_management_sdk.models.data_lock_config.DataLockConfig.from_dictionary(dictionary.get('datalock_config')) if dictionary.get('datalock_config') else None
