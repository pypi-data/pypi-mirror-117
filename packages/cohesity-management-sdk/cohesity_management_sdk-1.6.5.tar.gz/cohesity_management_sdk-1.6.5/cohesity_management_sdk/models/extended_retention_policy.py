...
class ExtendedRetentionPolicy(object):
    ...
    _names = {
        ...
        "data_lock_config":'data_lock_config',
    ...
    def from_dictionary(cls,
        ...
        data_lock_config = cohesity_management_sdk.models.data_lock_config.DataLockConfig.from_dictionary(dictionary.get('data_lock_config')) if dictionary.get('data_lock_config') else None
