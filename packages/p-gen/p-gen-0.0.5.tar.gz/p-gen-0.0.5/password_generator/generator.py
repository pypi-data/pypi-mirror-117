...
class PasswordGenerator:
    ...
    def __init__(self, *code_phrases, length=None, seed=None, use_special_symbols=None):
    ...
    def seed(self):
        ...
        return (
            "-".join(self._code_phrases) + self._seed * 2 + "-".join(self._code_phrases)
        )

    @property
    def symbols(self):
        return (
            self._SYMBOLS + self._SPECIAL_SYMBOLS
            if self._use_special_symbols
            else self._SYMBOLS
        )
