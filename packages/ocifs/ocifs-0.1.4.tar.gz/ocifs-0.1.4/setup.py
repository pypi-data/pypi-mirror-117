...
# with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'ocifs', '.version.json')) as version_file:
#     OCIFS_VERSION = json.load(version_file)['version']
...
setup(name='ocifs',
      ...
      description='Convenient filesystem interface over Oracle Cloud Infrastructure\'s Object Storage',
