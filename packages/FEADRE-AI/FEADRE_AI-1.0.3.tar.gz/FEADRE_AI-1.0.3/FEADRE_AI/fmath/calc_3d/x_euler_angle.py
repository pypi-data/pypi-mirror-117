...
predictor = dlib.shape_predictor(r"M:\AI\datas\face68\shape_predictor_68_face_landmarks.dat")
...
def get_pose_estimation(img_size, image_points):
    ...
    (success, rotation_vector, translation_vector) = cv2.solvePnP(
        model_points,  # (num_keypoints,3) 世界坐标 3D模型坐标
        image_points,  # (num_keypoints,2) 图像坐标系中点的坐标 xy
        camera_matrix,  # (3,3) 相机内参矩阵  通过标定
        dist_coeffs,  # (4,1) 畸变系数  通过标定
