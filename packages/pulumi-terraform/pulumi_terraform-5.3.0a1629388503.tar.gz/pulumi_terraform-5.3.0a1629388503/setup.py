...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', '5.3.0-alpha.1629388503+71d3289b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform 5.3.0-alpha.1629388503+71d3289b`
                """)
