...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'frontegg', '0.2.10', '--server', 'https://github.com/benesch/pulumi-frontegg/releases/download/v0.2.10/'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource frontegg 0.2.10`
                """)
            else:
                raise
