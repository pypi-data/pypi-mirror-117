...
class DiscreteEnv(gym.Env):
  def __init__(self):
    ...
    #set ACTION SPACE
    self.row = np.linspace(-2, 2, 50).tolist()
  ...
  def step(self, action): 
    ...
    action0, action1, action2 = action
    action_0, action_1, action_2 = self.onerow[action0], self.onerow[action1], self.onerow[action2]   
