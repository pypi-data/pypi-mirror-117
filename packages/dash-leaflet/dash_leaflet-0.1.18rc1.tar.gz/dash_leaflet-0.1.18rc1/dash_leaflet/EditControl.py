...
- drawMode (dict; optional):
    Change this prop to invoke a particular draw mode, similar to when
    a button in the toolbar is clicked.

    `drawMode` is a dict with keys:

    - mode (a value equal to: "marker", "polygon", "polyline", "rectangle", "circle", "circlemarker"; optional)

    - n_modes (number; optional)

- edit (dict; optional):
    Enable/disable edit controls. See example of usage here
    https://github.com/Leaflet/Leaflet.draw#user-content-example-leafletdraw-config.

- editMode (dict; optional):
    Change this prop to invoke a particular draw mode, similar to when
    a button in the toolbar is clicked.

    `editMode` is a dict with keys:
...
- position (a value equal to: "topleft", "topright", "bottomleft", "bottomright"; optional):
    ...
    @_explicitize_args
    def __init__(self, children=None, position=Component.UNDEFINED, draw=Component.UNDEFINED, edit=Component.UNDEFINED, action=Component.UNDEFINED, drawMode=Component.UNDEFINED, editMode=Component.UNDEFINED, geojson=Component.UNDEFINED, onMounted=Component.UNDEFINED, onDrawVertex=Component.UNDEFINED, onEditMove=Component.UNDEFINED, onEditResize=Component.UNDEFINED, onEditVertex=Component.UNDEFINED, className=Component.UNDEFINED, id=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'action', 'className', 'draw', 'drawMode', 'edit', 'editMode', 'geojson', 'onDrawVertex', 'onEditMove', 'onEditResize', 'onEditVertex', 'onMounted', 'position']
        self._type = 'EditControl'
        self._namespace = 'dash_leaflet'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'action', 'className', 'draw', 'drawMode', 'edit', 'editMode', 'geojson', 'onDrawVertex', 'onEditMove', 'onEditResize', 'onEditVertex', 'onMounted', 'position']
