...
Optionally, an Apache Spark Pipeline can be added to the release. For this, pyspark is needed.
The module can be installed with optional pyspark e.g. with: `pip install actico_ml[spark]`
