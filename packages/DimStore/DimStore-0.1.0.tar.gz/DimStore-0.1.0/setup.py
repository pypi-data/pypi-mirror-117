...
setup(
    ...
    description="DimStore is a project that aims to enable the collaboration of Data Science at the lowest and richest level.",
    long_description='DimStore is a project that aims to enable the collaboration of Data Science at the lowest and richest level.',
