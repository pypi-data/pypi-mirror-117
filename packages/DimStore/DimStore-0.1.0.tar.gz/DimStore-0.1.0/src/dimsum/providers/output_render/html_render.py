from dimsum.providers.output_render.output_render_base import OutputRenderBase
...
class HtmlRender(OutputRenderBase):
    ...
    def feature_list(self, output):
        ...
        table = """<table class='dimsum_feature_list'> 
                    <tr> 
                        <th>Feature</th> 
                        <th>Namespace</th>
                        <th>Tags</td>
    ...
    def namespace_list(self, output):
        style = """<style>
                    table.dimsum_ns_list,
                    table.dimsum_ns_list th,
                    table.dimsum_ns_list td {
                        border: 1px solid black;
                        }
                </style>"""
        table = """<table class='dimsum_ns_list'> 
                    <tr> 
                        <th>Namespace</th> 
    ...
    def __tags_to_html__(self, tags):
        if tags == None or len(tags) == 0:
            ...
            ul = """<ul class='dimsum_tags'>
                    %s
                </ul>"""
            li_inner = """<li class='dimsum_tag'>%s</li>"""
    ...
    def __feature_list_style__(self):
        style = """
            <style>
                table.dimsum_feature_list,
                table.dimsum_feature_list th,
                table.dimsum_feature_list td {
                    border: 1px solid black;
                    text-align: left;
                    }
                table.dimsum_feature_list th{
