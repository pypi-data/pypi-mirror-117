...
from dimsum.utility.watson_knowledge_catalog_client import WatsonKnowledgeCatalogClient
from dimsum.core.feature_metadata import FeatureOperation

class WatsonKnowledgeCatalogMetaManager(MetaManagerBase):
    ...
    def __get_wkc_client__(self):
        ...
        client = None
        try:
            client = WatsonKnowledgeCatalogClient(self.catalog_name, self.host, uid=self.uid, pwd=self.pwd, verbose=False)
    ...
    def __init_manager_asset_type__(self):
        ...
        """
        asset_type = {
                "description": "DimSum feature manager asset",
                "fields": [
                {
                    "key": "name",
                    "type": "string",
    ...
    def __init_manager_asset__(self):
        ...
        asset = {    
                    "metadata": {
                            ...
                            "description": "DimSum feature metadata manager asset.",
                            "tags": ["DimSum"],
