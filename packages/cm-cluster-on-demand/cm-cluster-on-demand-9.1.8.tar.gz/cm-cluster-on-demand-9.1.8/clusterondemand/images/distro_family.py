...
class ImageDistroSpec:
    ...
    _DISTRO_REGEX = [
        ...
        re.compile(r"^(?P<family>rocky|alma)(?:(?P<major>\d+)(?:u(?P<minor>\d+))?)?(?P<suffix>centos)?$"),
    ]
    ...
    def __init__(self, distro):
        ...
        for regex in self._DISTRO_REGEX:
            ...
            if match:
                family_suffix = (match["suffix"] or "") if "suffix" in regex.groupindex else ""
                self._family = match["family"] + family_suffix
