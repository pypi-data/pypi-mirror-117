...
def doc2df_wide(doc: spacy.tokens.Doc, regex_pmid: str = r"PMID: (\d+)") -> pd.DataFrame:
    """
...
def df2jsonl(df: pd.DataFrame, path: str = None, pmid: str = "pmid", text: str = "text", start: str = "start", stop: str = "stop", entity: str = "entity", entity_text: str = "entity_text") -> Union[str, None]:
    """
...
def adjust_tags(tags: List[str], tag_set: Set[str] = None, length: int = 512) -> List[List[str]]:
    """
