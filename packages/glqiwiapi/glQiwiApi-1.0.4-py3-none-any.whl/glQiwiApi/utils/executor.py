...
from glQiwiApi.core.advanced.webhooks import server
from glQiwiApi.core.advanced.webhooks.config import Path
...
def _setup_callbacks(
    ...
    """
    Function, which setup callbacks and set it to advanced object
