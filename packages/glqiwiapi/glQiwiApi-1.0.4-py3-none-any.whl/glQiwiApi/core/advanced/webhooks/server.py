...
from glQiwiApi.core.advanced.dispatcher import Dispatcher
from glQiwiApi.core.advanced.webhooks.config import (
...
from glQiwiApi.core.advanced.webhooks.utils import check_ip
from glQiwiApi.core.advanced.webhooks.views.bill_view import QiwiBillWebView
from glQiwiApi.core.advanced.webhooks.views.transaction_view import QiwiWebHookWebView
...
def configure_app(
    ...
    :param dispatcher: advanced, which processing events
