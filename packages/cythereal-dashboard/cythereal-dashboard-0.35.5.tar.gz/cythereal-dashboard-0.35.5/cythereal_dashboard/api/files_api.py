...
class FilesApi(object):
    ...
    def get_owned_files_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['_date', 'start_date', 'end_date', 'public', 'only_top_level', 'page', 'limit', 'file_type', 'children_file_type', 'children_only', 'group_by_parents', 'include_descendants', 'all_keys', 'keys']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
