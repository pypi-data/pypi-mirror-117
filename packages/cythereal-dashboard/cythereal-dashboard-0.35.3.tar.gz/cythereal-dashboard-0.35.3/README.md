...
try:
    ...
    api_response = api_instance.get_counts(all_files=all_files, children_only=children_only, files_only=files_only, file_type=file_type, children_file_type=children_file_type)
    pprint(api_response)
