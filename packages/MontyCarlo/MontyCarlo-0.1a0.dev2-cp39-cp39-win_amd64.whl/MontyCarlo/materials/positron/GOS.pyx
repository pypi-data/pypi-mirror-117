...
cdef class Close:
    ...
    cdef (double, double, double) J(double W):
        ...
        J0 = -1/W - b1*logW/STATE.E + b2*W/(STATE.E*STATE.E) - b3*W*W/(2*STATE.E*STATE.E*STATE.E) + b4*W*W*W/(3*STATE.E*STATE.E*STATE.E*STATE.E)              #1/diff + (1 - a)/STATE.E * log(diff/W) + a * W/ STATE.E**2
        
        J1 = logW - b1*W/STATE.E + b2*W*W/(2*STATE.E*STATE.E) - b3*W*W*W/(3*STATE.E*STATE.E*STATE.E) + b4*W*W*W*W/(4*STATE.E*STATE.E*STATE.E*STATE.E) 
                
        J2 = W - b1*W*W/STATE.E + b2*W*W*W/(3*STATE.E*STATE.E) - b3*W*W*W*W/(4*STATE.E*STATE.E*STATE.E) + b4*W*W*W*W*W/(5*STATE.E*STATE.E*STATE.E*STATE.E) 
