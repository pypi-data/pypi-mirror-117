...
class Binomial(Distribution):
    ...
    Attributes:
        ...
        n (integer) representint the number of trials
    ...
    def pmf(self, k):
        ...
        k_from_n_factorial = math.factorial(self.n - k)

        return (n_factorial)/(k_factorial * k_from_n_factorial) * (self.p ** k) * (1 - self.p) ** (self.n - k)
    ...
    def plot_pmf(self):
        ...
        plt.plot(x, y)
        plt.title("Probability mass function distribution")
