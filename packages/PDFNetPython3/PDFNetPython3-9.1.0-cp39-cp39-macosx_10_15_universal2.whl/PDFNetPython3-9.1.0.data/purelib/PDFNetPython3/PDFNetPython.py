...
class ObjSet(object):
    ...
    def __init__(self):
        _PDFNetPython.ObjSet_swiginit(self, _PDFNetPython.new_ObjSet())
...
class CADConvertOptions(object):
    ...
    def GetInternalObj(self):
        return _PDFNetPython.CADConvertOptions_GetInternalObj(self)
...
class HTMLOutputOptions(object):
    ...
    def SetPages(self, pageFrom, pageTo):
        return _PDFNetPython.HTMLOutputOptions_SetPages(self, pageFrom, pageTo)
...
class WordOutputOptions(object):
    ...
    def SetJPGQuality(self, quality):
        return _PDFNetPython.WordOutputOptions_SetJPGQuality(self, quality)

    def SetImageDPI(self, dpi):
        return _PDFNetPython.WordOutputOptions_SetImageDPI(self, dpi)
    ...
    def SetFileConversionTimeoutSeconds(self, seconds):
        return _PDFNetPython.WordOutputOptions_SetFileConversionTimeoutSeconds(self, seconds)

    def SetPages(self, pageFrom, pageTo):
        return _PDFNetPython.WordOutputOptions_SetPages(self, pageFrom, pageTo)

    def SetPDFPassword(self, password):
        return _PDFNetPython.WordOutputOptions_SetPDFPassword(self, password)
    e_bm_none = _PDFNetPython.WordOutputOptions_e_bm_none
    e_bm_page = _PDFNetPython.WordOutputOptions_e_bm_page
    e_bm_extract = _PDFNetPython.WordOutputOptions_e_bm_extract

    def SetBookmarkConversionMethod(self, method):
        return _PDFNetPython.WordOutputOptions_SetBookmarkConversionMethod(self, method)
    ...
    def SetShrinkCharacterSpacingToPreventWrap(self, shrink):
        return _PDFNetPython.WordOutputOptions_SetShrinkCharacterSpacingToPreventWrap(self, shrink)

    def SetMatchPDFLineBreaks(self, match):
        return _PDFNetPython.WordOutputOptions_SetMatchPDFLineBreaks(self, match)

    def SetConnectHyphens(self, connect):
        return _PDFNetPython.WordOutputOptions_SetConnectHyphens(self, connect)

    def SetDoNotAdjustFonts(self, do_not_adjust):
        return _PDFNetPython.WordOutputOptions_SetDoNotAdjustFonts(self, do_not_adjust)

    def SetDisableVerticalSplit(self, disable):
        return _PDFNetPython.WordOutputOptions_SetDisableVerticalSplit(self, disable)
