...
def virtual_network(stem, address_spaces):
    vn = network.VirtualNetwork(
        f'{preffix}{s}{stem}{s}virtualnetwork',
        virtual_network_name=f'{preffix}{s}{stem}{s}virtualnetwork',
...
def vnet_peering(
    ...
    vnp = network.VirtualNetworkPeering(
        f'{preffix}{s}{stem}{s}{env}{s}vnetpeer',
        name=f'{preffix}{s}{stem}{s}{env}{s}vnetpeer',
...
def subnet(
    ...
    sn = network.Subnet(
        f'{preffix}{s}{stem}{s}subnet',
        name=f'{preffix}{s}{stem}{s}subnet',
        resource_group_name=resource_group_name,
        virtual_network_name=virtual_network_name,
...
def subnet_special(
    ...
    sn = network.Subnet(
        f'{preffix}{s}{stem}{s}snet',
        name=f'{preffix}{s}{stem}{s}snet',
        subnet_name=name,
        resource_group_name=resource_group_name,
        virtual_network_name=virtual_network_name,
        address_prefix=address_prefix,
