...
class IReader(object):
    ...
    def SetIncludedChannels(self, includedChannels: "std::vector< int,std::allocator< int > > const &") -> "void":
...
class ConversionDriver(object):
    ...
    def SetRAMLimit(self, s: "size_t") -> "void":
...
class DirectoryDescription(object):
    ...
    def InspectByReferenceFile(self, path: "std::string") -> "void":
        return _pyglass.DirectoryDescription_InspectByReferenceFile(self, path)
...
def CreateProject(path: "path", projectName: "std::string") -> "ProjectIO::Project":
    return _pyglass.CreateProject(path, projectName)
...
class Project(object):
    ...
    def SetCoordinateFrame(self, coordinateFrame: "ProjectIO::CoordinateFrame const &") -> "void":
...
def RunPythonScript(path: "std::string const &", argv: "StringList") -> "std::string":
    return _pyglass.RunPythonScript(path, argv)
...
class IFile(object):
    ...
    def Write(self, source: "char const *", size: "size_t") -> "bool":
        return _pyglass.IFile_Write(self, source, size)
...
class FileHandle(object):
    ...
    def Write(self, source: "char const *", size: "size_t") -> "bool":
        return _pyglass.FileHandle_Write(self, source, size)
