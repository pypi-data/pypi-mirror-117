...
def process_tissue_frequency(x):
    freq_results = []
    freq_info = x.get("tissue_frequency__mstring")
...
register(
    ...
    transformer=compose(
        ...
        lambda x: assoc(
            x, "tissue_frequency__mstring", process_tissue_frequency(x)
        ),
