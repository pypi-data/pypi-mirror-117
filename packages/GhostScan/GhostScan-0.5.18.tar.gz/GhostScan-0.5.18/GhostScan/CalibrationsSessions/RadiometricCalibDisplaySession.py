...
class RadiometricCalibDisplaySession(CalibrationSession, ABC):
    ...
    def captureTest(self):
        ...
        cv2.waitKey(40)
        self.camera.getImage(name = 'DisplayRadiometric/'+ 'testImage', calibration=True)
        
        print('Capture Complete! Test image viewable at CalibrationImages/DisplayRadiometric/')
        cv2.waitKey(1000)
        cv2.destroyAllWindows()
        cv2.waitKey(1)
        cv2.waitKey(1)
