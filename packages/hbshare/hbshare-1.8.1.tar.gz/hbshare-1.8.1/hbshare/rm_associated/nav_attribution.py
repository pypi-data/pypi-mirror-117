...
if __name__ == '__main__':
    ...
    # 私募样例
    res = StyleAttribution(fund_id='SGX346', fund_type='private', start_date='20210104', end_date='20210813',
                           factor_type='style', benchmark_id='000905', nav_frequency='day').get_all()
