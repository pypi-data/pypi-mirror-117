...
from hbshare.rm_associated.util.data_loader import EquityBrinsonAttributionLoader
from hbshare.rm_associated.util.verifier import verify_type, verify_trading_day, \
    verify_df_not_null, verify_simple_data_duplicate
from hbshare.rm_associated.config import industry_names
...
if __name__ == '__main__':
    attr_result = EquityBrinsonAttribution(
        fund_id='500021', benchmark_id='000906', start_date='20191220', end_date='20210630').get_attribution_result()
