...
if __name__ == '__main__':
    res_ol, res_lc = BrinsonAttrCheck(fund_id='040002').get_construct_result()
    ...
    #
    # for fund_id in tqdm(f_info.index.tolist()[:100]):
    ...
    #     f_info.loc[fund_id, 'actual_num'] = BrinsonAttrCheck(fund_id).attr_result['realized_period_attr_df'].shape[0]
    #
    # print(123)
