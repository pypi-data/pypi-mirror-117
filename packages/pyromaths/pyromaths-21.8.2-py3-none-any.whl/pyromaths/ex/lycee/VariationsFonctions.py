...
class Vf1SensEtTableau(ex.TexExercise):
    ...
    def tex_statement(self):
        ...
        exo.append(r'label("$\mathcal{C}_f$", (%s,%s), align=%s);' % (self.lX[0], self.lY1[0], ('SE', 'NW', 'SW')[self.variations1[0][0]]))
        ...
        exo.append(r'draw(graph(xpt,ypt,Hermite(monotonic)),brown+1.5);')
        exo.append(r'labelx(L=scale(.7)*"$0$", (0,0), align=SW);')
        exo.append(r'label("$\mathcal{C}_g$", (%s,%s), align=%s);' % (self.lX[0], self.lY2[0], ('SE', 'NW', 'SW')[self.variations2[0][0]]))
        exo.append(r'\end{asy}')
