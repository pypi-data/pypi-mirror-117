...
class VersionInfo(object):
    ...
    def insights_enabled(self, insights_enabled):
        ...
        :type: bool
        """
        if self.local_vars_configuration.client_side_validation and insights_enabled is None:  # noqa: E501
            raise ValueError("Invalid value for `insights_enabled`, must not be `None`")  # noqa: E501
