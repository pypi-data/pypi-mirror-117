...
from hestia_earth.models.faostat2018.carcassWeightPerHead import TERM_ID, _should_run, run

class_path = 'hestia_earth.models.faostat2018.carcassWeightPerHead'
