        ...
        for history_id in data_tests:
            ...
            tests_results_data.append(
                JSONFixture.set_results_for_testrun(
                    ...
                    results_setup,
                    results_teardown,
                    data_tests[history_id]['descriptionHtml'] if 'descriptionHtml' in data_tests[history_id]
                    else data_tests[history_id]['statusDetails']['trace'] if 'statusDetails' in data_tests[history_id] and data_tests[history_id]['statusDetails'] else None,
                    links,
                    data_tests[history_id]['stop'] - data_tests[history_id]['start'],
                    None,
                    data_tests[history_id]['statusDetails']['message'] if 'statusDetails' in data_tests[history_id] and data_tests[history_id]['statusDetails'] else None,
