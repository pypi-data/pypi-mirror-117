...
"""
*  This file:/bisos/git/bxRepos/bisos-pip/provision/dev/bisos/provision/bootstrapPkgThis.py :: [[elisp:(org-cycle)][| ]]
...
####+BEGIN: bx:icm:python:cmnd:subSection :title "This Package Bases" :context "func-1"
    """
**   [[elisp:(org-cycle)][| ]] [[elisp:(org-show-subtree)][|=]] [[elisp:(show-children 10)][|V]] [[elisp:(bx:orgm:indirectBufOther)][|>]] [[elisp:(bx:orgm:indirectBufMain)][|I]] [[elisp:(blee:ppmm:org-mode-toggle)][|N]] [[elisp:(org-top-overview)][|O]] [[elisp:(progn (org-shifttab) (org-content))][|C]] [[elisp:(delete-other-windows)][|1]]          *This Package Bases*  [[elisp:(org-cycle)][| ]]  [[elisp:(org-show-subtree)][|=]] 
"""
####+END:
...
"""
        ...
        cmndArgsSpecDict.argsDictAdd(
            ...
            argName="actions",
            argDefault='all',
            argChoices=['all', 'pkgBase_modulesDir', 'pkgBase_configDir', 'pkgBase_genReposSpecDir',],
