...
class PrometheusServiceClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.31/reference/services/amp.html#PrometheusService.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.31/reference/services/amp.html#PrometheusService.Client.can_paginate)
    ...
    def create_workspace(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.31/reference/services/amp.html#PrometheusService.Client.create_workspace)
    ...
    def delete_workspace(self, *, workspaceId: str, clientToken: str = None) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.31/reference/services/amp.html#PrometheusService.Client.delete_workspace)
    ...
    def describe_workspace(self, *, workspaceId: str) -> DescribeWorkspaceResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.31/reference/services/amp.html#PrometheusService.Client.describe_workspace)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.31/reference/services/amp.html#PrometheusService.Client.generate_presigned_url)
    ...
    def list_workspaces(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.31/reference/services/amp.html#PrometheusService.Client.list_workspaces)
    ...
    def update_workspace_alias(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.31/reference/services/amp.html#PrometheusService.Client.update_workspace_alias)
    ...
    def get_paginator(self, operation_name: Literal["list_workspaces"]) -> ListWorkspacesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.31/reference/services/amp.html#PrometheusService.Paginator.ListWorkspaces)
