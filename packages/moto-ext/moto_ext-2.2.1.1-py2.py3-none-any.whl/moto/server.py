...
URL_INDEX = {
    ...
    'elasticbeanstalk': ['https?://elasticbeanstalk.(?P<region>[a-zA-Z0-9\\-_]+).amazonaws.com'],
    'elb': ['https?://elasticloadbalancing.(.+).amazonaws.com'],
    'elbv2': ['https?://elasticloadbalancing.(.+).amazonaws.com'],
    'emr': ['https?://(.+).elasticmapreduce.amazonaws.com', 'https?://elasticmapreduce.(.+).amazonaws.com'],
    ...
    'kinesis': ['https?://kinesis\\.(.+).amazonaws.com', 'https?://firehose.(.+).amazonaws.com'],
    ...
    's3': ['https?://s3(.*).amazonaws.com', 'https?://(?P<bucket_name>[a-zA-Z0-9\\-_.]*)\\.?s3(.*).amazonaws.com'],
    's3bucket_path': ['https?://s3(.*).amazonaws.com', 'https?://(?P<bucket_name>[a-zA-Z0-9\\-_.]*)\\.?s3(.*).amazonaws.com'],
