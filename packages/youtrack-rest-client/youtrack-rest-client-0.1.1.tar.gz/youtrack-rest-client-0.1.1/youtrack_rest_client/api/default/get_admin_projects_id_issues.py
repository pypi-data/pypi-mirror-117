...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/admin/projects/{id}/issues".format(client.youtrack_base_url, id=id)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[Issue]]:
...
def _build_response(*, response: httpx.Response) -> Response[List[Issue]]:
    return Response(
