...
def _parse_response(*, response: httpx.Response) -> Optional[TimeTrackingUserProfile]:
...
def _build_response(*, response: httpx.Response) -> Response[TimeTrackingUserProfile]:
    return Response(
