...
def _parse_response(*, response: httpx.Response) -> Optional[List[IssueComment]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = IssueComment.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[IssueComment]]:
    return Response(
