...
if TYPE_CHECKING:
    from ..models.database_multi_value_issue_custom_field_value import DatabaseMultiValueIssueCustomFieldValue
    from ..models.project_custom_field import ProjectCustomField
else:
    ProjectCustomField = "ProjectCustomField"
    DatabaseMultiValueIssueCustomFieldValue = "DatabaseMultiValueIssueCustomFieldValue"
...
class DatabaseMultiValueIssueCustomField(IssueCustomField):
    ...
    value: Union[Unset, DatabaseMultiValueIssueCustomFieldValue] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        value: Union[Unset, DatabaseMultiValueIssueCustomFieldValue]
        if isinstance(_value, Unset):
            value = UNSET
        else:
            value = DatabaseMultiValueIssueCustomFieldValue.from_dict(_value)
        ...
        database_multi_value_issue_custom_field.additional_properties = d
