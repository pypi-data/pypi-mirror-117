...
class StateBundleCustomFieldDefaults(BundleCustomFieldDefaults):
    ...
    bundle: Union[Unset, StateBundle] = UNSET
    default_values: Union[Unset, List[StateBundleElement]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bundle: Union[Unset, StateBundle]
        if isinstance(_bundle, Unset):
            bundle = UNSET
        else:
            bundle = StateBundle.from_dict(_bundle)

        default_values = []
        _default_values = d.pop("defaultValues", UNSET)
        for default_values_item_data in _default_values or []:
            default_values_item = StateBundleElement.from_dict(default_values_item_data)
        ...
        state_bundle_custom_field_defaults.additional_properties = d
