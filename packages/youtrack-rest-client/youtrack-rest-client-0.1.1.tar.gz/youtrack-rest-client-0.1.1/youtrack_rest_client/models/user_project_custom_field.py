...
class UserProjectCustomField(BundleProjectCustomField):
    ...
    bundle: Union[Unset, UserBundle] = UNSET
    default_values: Union[Unset, List[User]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bundle: Union[Unset, UserBundle]
        if isinstance(_bundle, Unset):
            bundle = UNSET
        else:
            bundle = UserBundle.from_dict(_bundle)

        default_values = []
        _default_values = d.pop("defaultValues", UNSET)
        for default_values_item_data in _default_values or []:
            default_values_item = User.from_dict(default_values_item_data)
