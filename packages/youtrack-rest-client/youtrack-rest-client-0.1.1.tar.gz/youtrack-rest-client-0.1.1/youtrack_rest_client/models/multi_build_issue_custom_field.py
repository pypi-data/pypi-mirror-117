...
class MultiBuildIssueCustomField(DatabaseMultiValueIssueCustomField):
    ...
    value: Union[Unset, BuildBundleElement] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        value: Union[Unset, BuildBundleElement]
        if isinstance(_value, Unset):
            value = UNSET
        else:
            value = BuildBundleElement.from_dict(_value)
        ...
        multi_build_issue_custom_field.additional_properties = d
