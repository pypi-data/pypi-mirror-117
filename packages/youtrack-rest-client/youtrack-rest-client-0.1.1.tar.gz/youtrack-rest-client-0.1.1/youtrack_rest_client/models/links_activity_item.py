...
T = TypeVar("T", bound="LinksActivityItem")
...
class LinksActivityItem(MultiValueActivityItem):
    ...
    removed: Union[Unset, List[Issue]] = UNSET
    added: Union[Unset, List[Issue]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for removed_item_data in _removed or []:
            removed_item = Issue.from_dict(removed_item_data)
        ...
        for added_item_data in _added or []:
            added_item = Issue.from_dict(added_item_data)

            added.append(added_item)

        links_activity_item = cls(
            target=target,
            removed=removed,
            added=added,
        ...
        links_activity_item.additional_properties = d
        return links_activity_item
