...
class StateIssueCustomField(database_single_value_issue_custom_field.DatabaseSingleValueIssueCustomField):
    """Represents the issue field of the `state` type."""

    value: "Union[Unset, state_bundle_element_m.StateBundleElement]" = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        value: Union[Unset, state_bundle_element_m.StateBundleElement]
        if isinstance(_value, Unset):
            value = UNSET
        else:
            value = state_bundle_element_m.StateBundleElement.from_dict(_value)
