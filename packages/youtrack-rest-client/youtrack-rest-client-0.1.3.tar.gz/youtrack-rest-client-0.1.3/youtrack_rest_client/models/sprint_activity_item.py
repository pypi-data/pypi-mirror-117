...
T = TypeVar("T", bound="SprintActivityItem")
...
class SprintActivityItem(multi_value_activity_item.MultiValueActivityItem):
    ...
    removed: "Union[Unset, List[sprint_m.Sprint]]" = UNSET
    added: "Union[Unset, List[sprint_m.Sprint]]" = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for removed_item_data in _removed or []:
            removed_item = sprint_m.Sprint.from_dict(removed_item_data)
        ...
        for added_item_data in _added or []:
            added_item = sprint_m.Sprint.from_dict(added_item_data)

            added.append(added_item)

        sprint_activity_item = cls(
            target=target,
            removed=removed,
            added=added,
        )

        sprint_activity_item.additional_properties = d
        return sprint_activity_item
