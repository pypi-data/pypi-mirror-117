...
T = TypeVar("T", bound="VisibilityGroupActivityItem")
...
class VisibilityGroupActivityItem(visibility_activity_item.VisibilityActivityItem):
    ...
    removed: "Union[Unset, List[user_group_m.UserGroup]]" = UNSET
    added: "Union[Unset, List[user_group_m.UserGroup]]" = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for removed_item_data in _removed or []:
            removed_item = user_group_m.UserGroup.from_dict(removed_item_data)
        ...
        for added_item_data in _added or []:
            added_item = user_group_m.UserGroup.from_dict(added_item_data)

            added.append(added_item)

        visibility_group_activity_item = cls(
        ...
        visibility_group_activity_item.additional_properties = d
        return visibility_group_activity_item
