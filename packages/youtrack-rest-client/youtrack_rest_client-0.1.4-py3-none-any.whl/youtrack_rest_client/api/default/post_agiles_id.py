...
def _parse_response(*, response: httpx.Response) -> Optional[agile_m.Agile]:
    if response.status_code == 200:
        response_200 = agile_m.Agile.from_dict(response.json())

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[agile_m.Agile]:
    return Response(
