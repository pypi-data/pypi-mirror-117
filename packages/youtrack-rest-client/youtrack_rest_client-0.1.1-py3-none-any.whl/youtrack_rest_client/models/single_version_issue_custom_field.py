...
T = TypeVar("T", bound="SingleVersionIssueCustomField")
...
class SingleVersionIssueCustomField(DatabaseSingleValueIssueCustomField):
    ...
    value: Union[Unset, VersionBundleElement] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        value: Union[Unset, VersionBundleElement]
        if isinstance(_value, Unset):
            value = UNSET
        else:
            value = VersionBundleElement.from_dict(_value)

        single_version_issue_custom_field = cls(
            value=value,
            **_DatabaseSingleValueIssueCustomField_kwargs,
        )

        single_version_issue_custom_field.additional_properties = d
        return single_version_issue_custom_field
