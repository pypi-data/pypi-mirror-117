...
if TYPE_CHECKING:
    from ..models.database_single_value_issue_custom_field_value import DatabaseSingleValueIssueCustomFieldValue
    from ..models.project_custom_field import ProjectCustomField
else:
    DatabaseSingleValueIssueCustomFieldValue = "DatabaseSingleValueIssueCustomFieldValue"
...
class DatabaseSingleValueIssueCustomField(IssueCustomField):
    ...
    value: Union[Unset, DatabaseSingleValueIssueCustomFieldValue] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        value: Union[Unset, DatabaseSingleValueIssueCustomFieldValue]
        if isinstance(_value, Unset):
            value = UNSET
        else:
            value = DatabaseSingleValueIssueCustomFieldValue.from_dict(_value)
