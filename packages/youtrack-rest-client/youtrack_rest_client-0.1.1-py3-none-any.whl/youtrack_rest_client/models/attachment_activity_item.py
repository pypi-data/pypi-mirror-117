...
T = TypeVar("T", bound="AttachmentActivityItem")
...
class AttachmentActivityItem(CreatedDeletedActivityItem):
    ...
    target: Union[Unset, IssueAttachment] = UNSET
    removed: Union[Unset, List[IssueAttachment]] = UNSET
    added: Union[Unset, List[IssueAttachment]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        target: Union[Unset, IssueAttachment]
        if isinstance(_target, Unset):
            target = UNSET
        else:
            target = IssueAttachment.from_dict(_target)

        removed = []
        _removed = d.pop("removed", UNSET)
        for removed_item_data in _removed or []:
            removed_item = IssueAttachment.from_dict(removed_item_data)
        ...
        for added_item_data in _added or []:
            added_item = IssueAttachment.from_dict(added_item_data)

            added.append(added_item)

        attachment_activity_item = cls(
            target=target,
            removed=removed,
            added=added,
        ...
        attachment_activity_item.additional_properties = d
        return attachment_activity_item
