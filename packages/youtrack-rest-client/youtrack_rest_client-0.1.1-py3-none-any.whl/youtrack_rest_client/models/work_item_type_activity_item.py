...
class WorkItemTypeActivityItem(MultiValueActivityItem):
    ...
    removed: Union[Unset, List[WorkItemType]] = UNSET
    added: Union[Unset, List[WorkItemType]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for removed_item_data in _removed or []:
            removed_item = WorkItemType.from_dict(removed_item_data)
        ...
        for added_item_data in _added or []:
            added_item = WorkItemType.from_dict(added_item_data)
        ...
        work_item_type_activity_item.additional_properties = d
