...
class SprintActivityItem(MultiValueActivityItem):
    ...
    removed: Union[Unset, List[Sprint]] = UNSET
    added: Union[Unset, List[Sprint]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for removed_item_data in _removed or []:
            removed_item = Sprint.from_dict(removed_item_data)
        ...
        for added_item_data in _added or []:
            added_item = Sprint.from_dict(added_item_data)
