...
class VisibilityGroupActivityItem(VisibilityActivityItem):
    ...
    removed: Union[Unset, List[UserGroup]] = UNSET
    added: Union[Unset, List[UserGroup]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for removed_item_data in _removed or []:
            removed_item = UserGroup.from_dict(removed_item_data)
        ...
        for added_item_data in _added or []:
            added_item = UserGroup.from_dict(added_item_data)
