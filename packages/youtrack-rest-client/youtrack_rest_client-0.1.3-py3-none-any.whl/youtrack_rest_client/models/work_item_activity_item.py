...
class WorkItemActivityItem(created_deleted_activity_item.CreatedDeletedActivityItem):
    """Represents a change in a list of work items in an issue."""

    target: "Union[Unset, issue_work_item_m.IssueWorkItem]" = UNSET
    removed: "Union[Unset, List[issue_work_item_m.IssueWorkItem]]" = UNSET
    added: "Union[Unset, List[issue_work_item_m.IssueWorkItem]]" = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for removed_item_data in _removed or []:
            removed_item = issue_work_item_m.IssueWorkItem.from_dict(removed_item_data)
        ...
        for added_item_data in _added or []:
            added_item = issue_work_item_m.IssueWorkItem.from_dict(added_item_data)
