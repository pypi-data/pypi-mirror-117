...
* Remove ioc_finder from the ioc parser.
* Allow users to select which iocs they would like to search for.

## 4.7.0 2021-08-19

* added option to keep single lists in flattener.

## 4.6.6 2021-08-12

* Removed Classifier: Programming Language :: Python :: 2 from pkg info
* Updated ioc_finder from version 6.0.0 to 6.0.1
* Refactored to increase speed of ioc parser
* Removed outputs:  attack_mitigations, attack_tactics, attack_techniques, and file paths from the method parse_iocs
* Version locked requests to 2.26.0

## 4.6.4 2021-07-15

* Removed py2 legacy code
* Updated ioc_finder from version 5.0.3 to 6.0.0

## 4.6.3 2021-06-09

* fix issue with flattener erring when raw_json is already in the dictionary.

## 4.6.2 2021-05-28

* the raw_json field added by the flattener now returns the object instead of the json string
* In IOCTyper, find domains before filenames so that domains aren't misclassified as filenames.
...
* updated jenkins file to use parallel pytest
