...
class NodeRetrieve(ModelNormal):
    ...
    def _from_openapi_data(cls, project, node, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            key (str): A unique, and very difficult to guess, key to access this node if it is not public.. [optional] if omitted the server will use the default value of "PcHqBjZV4bTpbHtXpw42FAo8krH286GS"  # noqa: E501
