...
class GloveEmbeddingLayer(EmbeddingLayer):
    ...
    def __init__(self, emb_layer_trainable=True):
        ...
        glove_path = "/home/local/ASUAD/ujeong1/PycharmProjects/Adversarial_UI/word_embeddings/glove200/"
        glove_word_list_path = os.path.join(glove_path, "glove200.wordlist.npy")
        word_list = np.load(glove_word_list_path)
        glove_matrix_path = os.path.join(glove_path, "glove200.6B.200d.mat.npy")
