...
from customattack.goal_function_results import GoalFunctionResult
...
class AttackResult(ABC):
    ...
    Args:
        original_result (:class:`~customattack.goal_function_results.GoalFunctionResult`):
            Result of the goal function applied to the original text
        perturbed_result (:class:`~customattack.goal_function_results.GoalFunctionResult`):
