...
_COMMITSBETWEENREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pagination_params', full_name='gitaly.CommitsBetweenRequest.pagination_params', index=3,
...
_COMMITSBETWEENREQUEST.fields_by_name['pagination_params'].message_type = shared__pb2._PAGINATIONPARAMETER
