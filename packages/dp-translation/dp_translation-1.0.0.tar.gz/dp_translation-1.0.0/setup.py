...
setup(
    name='dp_translation',  # Required
    version=version,  # Required
    description='Utilities to retrieve general .json files and more specifically jsonschema files',  # Optional
    long_description=long_description,
    long_description_content_type='text/x-rst',
    url='https://github.com/dataPuzzler/dp_translation',  # Optional
    ...
    keywords='translation, i18n',  # Optional
