...
setup(
  ...
  packages=setuptools.find_packages(where="src", exclude=("tests",)),   # Chose the same as "name"
  ...
  download_url = 'https://github.com/vikozlov89/extended_preprocessors/archive/refs/tags/v_0_0_8.tar.gz',    # I explain this later on
