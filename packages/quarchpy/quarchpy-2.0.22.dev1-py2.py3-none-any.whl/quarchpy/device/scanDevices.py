...
def list_USB(debuPrint=False):
    ...
    if usb_permission_error:
        logging.warning("Permission error accessing 1 or more Quarch USB modules.")
        logging.warning("Run the command 'sudo python3 -m quarchpy.run debug -usbfix' to add a new usb rule.")
