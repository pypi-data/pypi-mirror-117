...
def _parse_response(*, response: httpx.Response) -> Optional[SshPublicKey]:
    if response.status_code == 200:
        response_200 = SshPublicKey.from_dict(response.json())

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[SshPublicKey]:
    return Response(
