...
class BackupStatus:
    ...
    saved_data: "Union[Unset, List[backup_data_m.BackupData]]" = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        try:
            from ..models import backup_data as backup_data_m
        except ImportError:
            import sys

            backup_data_m = sys.modules[__package__ + "backup_data"]
        ...
        for saved_data_item_data in _saved_data or []:
            saved_data_item = backup_data_m.BackupData.from_dict(saved_data_item_data)
