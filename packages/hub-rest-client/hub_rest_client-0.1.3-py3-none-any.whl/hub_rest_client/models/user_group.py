...
class UserGroup(authority_holder.AuthorityHolder):
    """ """
    ...
    parent: "Union[Unset, user_group_m.UserGroup]" = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        parent: Union[Unset, user_group_m.UserGroup]
        if isinstance(_parent, Unset):
            parent = UNSET
        else:
            parent = user_group_m.UserGroup.from_dict(_parent)
