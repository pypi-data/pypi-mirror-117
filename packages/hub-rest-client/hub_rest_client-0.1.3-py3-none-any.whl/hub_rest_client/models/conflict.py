...
class Conflict:
    ...
    local: "Union[Unset, info_m.Info]" = UNSET
    remote: "Union[Unset, info_m.Info]" = UNSET
    resolution: "Union[Unset, resolution_m.Resolution]" = UNSET
    matches: "Union[Unset, info_m.Info]" = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        try:
            ...
            from ..models import resolution as resolution_m
        except ImportError:
            import sys

            resolution_m = sys.modules[__package__ + "resolution"]
        ...
        local: Union[Unset, info_m.Info]
        if isinstance(_local, Unset):
            local = UNSET
        else:
            local = info_m.Info.from_dict(_local)

        _remote = d.pop("remote", UNSET)
        remote: Union[Unset, info_m.Info]
        if isinstance(_remote, Unset):
            remote = UNSET
        else:
            remote = info_m.Info.from_dict(_remote)

        _resolution = d.pop("resolution", UNSET)
        resolution: Union[Unset, resolution_m.Resolution]
        if isinstance(_resolution, Unset):
            resolution = UNSET
        else:
            resolution = resolution_m.Resolution.from_dict(_resolution)

        _matches = d.pop("matches", UNSET)
        matches: Union[Unset, info_m.Info]
        if isinstance(_matches, Unset):
            matches = UNSET
        else:
            matches = info_m.Info.from_dict(_matches)
