...
class Service(authority_holder.AuthorityHolder):
    """ """
    ...
    untrusted_redirect_uris: "Union[Unset, List[untrusted_redirect_uri_m.UntrustedRedirectURI]]" = UNSET
    ...
    default_roles: "Union[Unset, List[role_m.Role]]" = UNSET
    viewers: "Union[Unset, List[authority_holder_m.AuthorityHolder]]" = UNSET
    license_settings: "Union[Unset, license__m.License]" = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for untrusted_redirect_uris_item_data in _untrusted_redirect_uris or []:
            untrusted_redirect_uris_item = untrusted_redirect_uri_m.UntrustedRedirectURI.from_dict(
                untrusted_redirect_uris_item_data
            )
        ...
        for default_roles_item_data in _default_roles or []:
            default_roles_item = role_m.Role.from_dict(default_roles_item_data)
        ...
        license_settings: Union[Unset, license__m.License]
        if isinstance(_license_settings, Unset):
            license_settings = UNSET
        else:
            license_settings = license__m.License.from_dict(_license_settings)
