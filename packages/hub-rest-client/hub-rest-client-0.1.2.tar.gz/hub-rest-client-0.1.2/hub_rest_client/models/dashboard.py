...
class Dashboard(uuid.Uuid):
    ...
    permissions: "Union[Unset, List[dashboard_permission_m.DashboardPermission]]" = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        try:
            ...
            dashboard_permission_m = sys.modules[__package__ + "dashboard_permission"]
        ...
        for permissions_item_data in _permissions or []:
            permissions_item = dashboard_permission_m.DashboardPermission.from_dict(permissions_item_data)
