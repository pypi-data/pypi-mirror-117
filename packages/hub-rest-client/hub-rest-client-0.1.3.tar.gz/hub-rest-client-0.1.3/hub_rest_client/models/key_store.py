...
class KeyStore:
    ...
    data: "Union[Unset, key_store_data_m.KeyStoreData]" = UNSET
    certificate: "Union[Unset, certificate_info_m.CertificateInfo]" = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        try:
            ...
            from ..models import certificate_info as certificate_info_m
            from ..models import key_store_data as key_store_data_m
        except ImportError:
            import sys

            alias_m = sys.modules[__package__ + "alias"]
            certificate_info_m = sys.modules[__package__ + "certificate_info"]
            key_store_data_m = sys.modules[__package__ + "key_store_data"]
        ...
        data: Union[Unset, key_store_data_m.KeyStoreData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = key_store_data_m.KeyStoreData.from_dict(_data)

        _certificate = d.pop("certificate", UNSET)
        certificate: Union[Unset, certificate_info_m.CertificateInfo]
        if isinstance(_certificate, Unset):
            certificate = UNSET
        else:
            certificate = certificate_info_m.CertificateInfo.from_dict(_certificate)
