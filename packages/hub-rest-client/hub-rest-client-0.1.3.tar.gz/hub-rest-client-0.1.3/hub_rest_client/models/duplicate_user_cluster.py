...
class DuplicateUserCluster:
    ...
    users: "Union[Unset, List[duplicate_user_m.DuplicateUser]]" = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        try:
            from ..models import duplicate_user as duplicate_user_m
        except ImportError:
            import sys

            duplicate_user_m = sys.modules[__package__ + "duplicate_user"]
        ...
        for users_item_data in _users or []:
            users_item = duplicate_user_m.DuplicateUser.from_dict(users_item_data)
