...
class ServiceProviderMetadata(provider_metadata.ProviderMetadata):
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _ProviderMetadata_kwargs = super().from_dict(src_dict=d).to_dict()
        _ProviderMetadata_kwargs.pop("$type")
