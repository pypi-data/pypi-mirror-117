...
def _parse_response(*, response: httpx.Response) -> Optional[event_m.Event]:
    if response.status_code == 200:
        response_200 = event_m.Event.from_dict(response.json())

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[event_m.Event]:
    return Response(
