...
@jsii.data_type(
    jsii_type="cdk-pipelines-github.AwsCredentialsSecertNames",
    jsii_struct_bases=[],
    name_mapping={
...
class AwsCredentialsSecertNames:
    def __init__(
        self,
        *,
    ...
    def __repr__(self) -> str:
        return "AwsCredentialsSecertNames(%s)" % ", ".join(
...
class GitHubWorkflow(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        aws_credentials: typing.Optional[AwsCredentialsSecertNames] = None,
...
class GitHubWorkflowProps(aws_cdk.pipelines.PipelineBaseProps):
    def __init__(
        ...
        *,
        ...
        if isinstance(aws_credentials, dict):
            aws_credentials = AwsCredentialsSecertNames(**aws_credentials)
    ...
    @builtins.property
    def aws_credentials(self) -> typing.Optional[AwsCredentialsSecertNames]:
        ...
        return typing.cast(typing.Optional[AwsCredentialsSecertNames], result)
