...
def add_graphql_to_class(model, filter_fields, query_class):
    ...
    _Model = type(app_label+"__"+_model.__name__+"__class", (DjangoObjectType,), { "Meta": Meta})

    setattr(query_class, app_label+"__"+_model.__name__, Node.Field(_Model))
    setattr(query_class, app_label+"__"+_model.__name__ + "All", DjangoFilterConnectionField(_Model))
