...
from pytigon_lib.schdjangoext.formwidgets import CheckboxSelectMultipleWithIcon, RadioSelectWithIcon
from django_select2.forms import Select2Widget, Select2MultipleWidget, HeavySelect2Widget, HeavySelect2MultipleWidget, ModelSelect2Widget, ModelSelect2MultipleWidget
...
class HeavySelect2Field(forms.ChoiceField):
    def __init__(self, data_url, attrs={}, **kwargs):
        widget = HeavySelect2Widget(data_url, attrs=attrs)
        super().__init__(widget=widget, **kwargs)


class HeavySelect2MultipleField(forms.MultipleChoiceField):
    def __init__(self, data_url, attrs={}, **kwargs):
        widget = HeavySelect2MultipleWidget(data_url, attrs=attrs)
        super().__init__(widget=widget, **kwargs)


class ModelSelect2Field(forms.ChoiceField):
    def __init__(self, model=None, queryset=None, search_fields=None, attrs={}, empty_label="-----", **kwargs):
        widget = ModelSelect2Widget(model=model, queryset=queryset, search_fields=search_fields, empty_label=empty_label, attrs=attrs)
        super().__init__(widget=widget, **kwargs)


class ModelSelect2MultipleField(forms.MultipleChoiceField):
    def __init__(self, model=None, queryset=None, search_fields=None, attrs={}, empty_label="-----", **kwargs):
        widget = ModelSelect2MultipleWidget(model=model, queryset=queryset, search_fields=search_fields, empty_label=empty_label, attrs=attrs)
        super().__init__(widget=widget, **kwargs)
