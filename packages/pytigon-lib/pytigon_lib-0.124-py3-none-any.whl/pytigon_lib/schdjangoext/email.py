...
class PytigonEmailMessage(EmailMultiAlternatives):
    ...
    def set_body(self, context, html_template_name, txt_template_name=None):
        ...
        txt_template_name2 = txt_template_name if txt_template_name else html_template_name.replace(".html", ".txt")
...
def send_message(subject, message_html_template_name, from_email, to, bcc, context={}, message_txt_template_name=None, prepare_message=None):
