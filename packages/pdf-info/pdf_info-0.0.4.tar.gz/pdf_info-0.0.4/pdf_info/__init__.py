...
class pdf_info_class:
    ...
    def convert(file_path,header_para_key,result_list, pages=None):
        # print('hello')
        # db = client[db_name]
        ...
        for page in PDFPage.get_pages(infile, pagenums, caching=caching, check_extractable=True):
            ...
            mydict['headers'] = res   #changed
            mydict['paragraphs'] = temp_dict['<p>'][-1]  # changed
    ...
    def pdf_info(self,file_path):
        result_list=[]
        header_para_key = pdf_info_class.extract_header_para_keywords(file_path)
        pdf_info_class.convert(file_path,header_para_key,result_list)
        return result_list
