...
class TectonContext:
    ...
    def execute(
        ...
        df = _filter_internal_columns(df)
    ...
    def _register_temp_views_for_feature_view(
        ...
        for vds in virtual_data_sources:
            self._register_temp_view_for_data_source(
                None, vds, register_stream=register_stream, raw_data_time_limits=raw_data_time_limits, fwv3=True
            )
...
def _filter_internal_columns(df):
