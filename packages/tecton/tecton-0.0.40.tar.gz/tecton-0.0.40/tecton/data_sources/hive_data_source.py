...
class HiveDSConfig(BaseBatchDataSource):
    ...
    Instead, declare as part of BatchDataSource that takes this configuration class instance as an input.
    """
    ...
    def __init__(
        ...
        .. code-block:: python
            ...
            from tecton import HiveDSConfig, BatchDataSource, inlined
            import pyspark
