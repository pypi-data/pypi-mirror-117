...
class CreateItem(BaseItemRequest):
    def __call__(self, name, slug, price, active=True, extra_attrs=dict(), description="", images=dict(), shippable=False, interval=None, interval_count=None, trial_interval=None, trial_interval_count=None, offers=[], category=None, accounting_id=None, api_key=None, timeout=None):
        url = self.get_url()
...
class UpdateItem(ResolveItem):
    def __call__(self, uuid, name=None, slug=None, price=None, active=None, extra_attrs=None, description=None, images=None, shippable=None, interval=None, interval_count=None, trial_interval=None, trial_interval_count=None, offers=None, category=None, accounting_id=None, api_key=None, timeout=None):
        assert uuid
