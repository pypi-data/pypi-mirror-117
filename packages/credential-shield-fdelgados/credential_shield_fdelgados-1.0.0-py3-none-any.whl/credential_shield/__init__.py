...
class UserData:
    def __init__(self, token_claims: Dict):
        _, application_id = token_claims.get('sub').split('@')
        self._application_id = application_id
        self._tenant_id = token_claims.get('aud')
...
class TokenValidator:
    ...
    def __init__(self, tenant_id: str, application_id: str, scope: str, token_issuer: str):
        self._tenant_id = tenant_id
        self._application_id = application_id
        self._scope = scope
        self._token_issuer = token_issuer

    def validate(self, access_token: str, public_key: str) -> UserData:
