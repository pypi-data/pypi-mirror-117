...
class CloudFormationTemplate(
    ...
    def __init__(self) -> None:
        ...
        :stability: experimental
        '''
        jsii.create(CloudFormationTemplate, self, [])
...
class Product(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(Product, self, [scope, id, props])
...
class TagOptions(
    ...
    def __init__(
        ...
        :stability: experimental
        '''
        jsii.create(TagOptions, self, [tag_options_map])
...
class CloudFormationProduct(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(CloudFormationProduct, self, [scope, id, props])
