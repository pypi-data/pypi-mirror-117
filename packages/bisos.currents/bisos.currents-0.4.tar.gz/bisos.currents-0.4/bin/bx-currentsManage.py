...
"""
*  This file:/de/bx/nne/dev-py/pypi/pkgs/bisos/currents/dev/bin/bx-currentsManage.py :: [[elisp:(org-cycle)][| ]]
...
__icmName__ = "bx-currentsManage"
####+END:

####+BEGIN: bx:global:timestamp:version-py :style "date"
__version__ = "201805304146"
####+END:
...
g_importedCmnds = {        # Enumerate modules from which CMNDs become invokable
    ...
    'bxCurrentsConfig': bxCurrentsConfig.__file__,
}
...
####+END:
    ...
    bxCurrentsConfig.commonParamsSpecify(icmParams)
