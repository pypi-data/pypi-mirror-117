    ...
    def Parse(self, src: bytes):
        ...
        while pos + dataLen < len(unpack.GetAll()):
            ...
            if msgType == 1:  # 纯文本 && 艾特
                ...
                self.MsgText += "[PQ:face=" + IdToFace(unpack.GetByte()) + "]"
