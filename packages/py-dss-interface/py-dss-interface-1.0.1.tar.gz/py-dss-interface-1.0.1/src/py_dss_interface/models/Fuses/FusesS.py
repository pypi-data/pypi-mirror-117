...
class FusesS(Base):
    ...
    def fuses_read_switched_obj(self) -> str:
    ...
    def fuses_write_switched_obj(self, argument) -> str:
    ...
    def fuses_read_tcc_curve(self) -> str:
    ...
    def fuses_write_tcc_curve(self, argument: str) -> str:
