...
class XYCurvesF(Base):
    ...
    def write_x(self, argument) -> float:
        """Sets the X value."""
    ...
    def write_x_shift(self, argument) -> float:
    ...
    def write_x_scale(self, argument) -> float:
