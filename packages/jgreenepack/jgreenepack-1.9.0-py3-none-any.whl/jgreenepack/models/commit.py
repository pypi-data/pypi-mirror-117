...
class Commit(object):
    ...
    def __init__(self, id=None, expected=None, _configuration=None):  # noqa: E501
    ...
    @property
    def expected(self):
        """Gets the expected of this Commit.  # noqa: E501

        Commit ID of external tool expected by dockerd as set at build time.   # noqa: E501

        :return: The expected of this Commit.  # noqa: E501
        :rtype: str
        """
