...
class PluginConfig(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, documentation, interface, entrypoint, work_dir, network, linux, propagated_mount, ipc_host, pid_host, mounts, env, args, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, documentation, interface, entrypoint, work_dir, network, linux, propagated_mount, ipc_host, pid_host, mounts, env, args, *args, **kwargs):  # noqa: E501
        """PluginConfig - a model defined in OpenAPI
