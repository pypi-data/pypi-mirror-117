...
class SystemAuthResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, status, *args, **kwargs):  # noqa: E501
        """SystemAuthResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            identity_token (str): An opaque token used to authenticate a user after a successful login. [optional]  # noqa: E501
        """
