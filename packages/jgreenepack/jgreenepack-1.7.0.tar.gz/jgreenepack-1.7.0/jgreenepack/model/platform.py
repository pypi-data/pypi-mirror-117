...
class Platform(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            architecture (str): Architecture represents the hardware architecture (for example, `x86_64`). . [optional]  # noqa: E501
            os (str): OS represents the Operating System (for example, `linux` or `windows`). . [optional]  # noqa: E501
        """
