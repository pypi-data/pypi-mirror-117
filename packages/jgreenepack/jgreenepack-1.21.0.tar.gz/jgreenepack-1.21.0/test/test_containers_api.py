...
import jgreenepack
from jgreenepack.jgreenepack.api.containers_api import ContainersApi  # noqa: E501
...
class TestContainersApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = jgreenepack.jgreenepack.api.containers_api.ContainersApi()  # noqa: E501
