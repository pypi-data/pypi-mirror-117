...
class RestartPolicy(object):
    ...
    def __init__(self, name=None, maximum_retry_count=None, _configuration=None):  # noqa: E501
        """RestartPolicy - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this RestartPolicy.  # noqa: E501

        - Empty string means not to restart - `no` Do not automatically restart - `always` Always restart - `unless-stopped` Restart always except when the user has manually stopped the container - `on-failure` Restart only when the container exit code is non-zero   # noqa: E501

        :return: The name of this RestartPolicy.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def maximum_retry_count(self):
        """Gets the maximum_retry_count of this RestartPolicy.  # noqa: E501

        If `on-failure` is used, the number of times to retry before giving up.   # noqa: E501

        :return: The maximum_retry_count of this RestartPolicy.  # noqa: E501
        :rtype: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RestartPolicy, dict):
