...
class InfraEnvUpdateParams(object):
    ...
    def __init__(self, proxy=None, additional_ntp_sources=None, ssh_authorized_key=None, pull_secret=None, static_network_config=None, image_type=None, ignition_config_override=None, cluster_id=None, _configuration=None):  # noqa: E501
    ...
    @property
    def cluster_id(self):
        """Gets the cluster_id of this InfraEnvUpdateParams.  # noqa: E501

        If set, all hosts that register will be associated with the specified cluster.  # noqa: E501

        :return: The cluster_id of this InfraEnvUpdateParams.  # noqa: E501
        :rtype: str
        """
    ...
    def cluster_id(self, cluster_id):
        """Sets the cluster_id of this InfraEnvUpdateParams.

        If set, all hosts that register will be associated with the specified cluster.  # noqa: E501

        :param cluster_id: The cluster_id of this InfraEnvUpdateParams.  # noqa: E501
        :type: str
        """
