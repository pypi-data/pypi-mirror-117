...
import jgreenepack
from jgreenepack.jgreenepack.models.organization_user import OrganizationUser  # noqa: E501
...
class TestOrganizationUser(unittest.TestCase):
    ...
    def testOrganizationUser(self):
        ...
        # model = jgreenepack.models.organization_user.OrganizationUser()  # noqa: E501
        pass
