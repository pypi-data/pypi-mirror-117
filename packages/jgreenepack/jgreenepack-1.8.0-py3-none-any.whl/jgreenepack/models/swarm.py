...
class Swarm(object):
    ...
    def __init__(self, join_tokens=None, _configuration=None):  # noqa: E501
        """Swarm - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._join_tokens = None
        self.discriminator = None

        if join_tokens is not None:
            self.join_tokens = join_tokens

    @property
    def join_tokens(self):
        """Gets the join_tokens of this Swarm.  # noqa: E501


        :return: The join_tokens of this Swarm.  # noqa: E501
        :rtype: JoinTokens
        """
        return self._join_tokens

    @join_tokens.setter
    def join_tokens(self, join_tokens):
