...
class TLSInfo(object):
    ...
    def __init__(self, trust_root=None, cert_issuer_subject=None, cert_issuer_public_key=None, _configuration=None):  # noqa: E501
        """TLSInfo - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._trust_root = None
        self._cert_issuer_subject = None
        self._cert_issuer_public_key = None
        self.discriminator = None

        if trust_root is not None:
            self.trust_root = trust_root
        if cert_issuer_subject is not None:
            self.cert_issuer_subject = cert_issuer_subject
        if cert_issuer_public_key is not None:
            self.cert_issuer_public_key = cert_issuer_public_key

    @property
    def trust_root(self):
        """Gets the trust_root of this TLSInfo.  # noqa: E501

        The root CA certificate(s) that are used to validate leaf TLS certificates.   # noqa: E501

        :return: The trust_root of this TLSInfo.  # noqa: E501
        :rtype: str
        """
        return self._trust_root

    @trust_root.setter
    def trust_root(self, trust_root):
    ...
    @property
    def cert_issuer_subject(self):
        """Gets the cert_issuer_subject of this TLSInfo.  # noqa: E501

        The base64-url-safe-encoded raw subject bytes of the issuer.  # noqa: E501

        :return: The cert_issuer_subject of this TLSInfo.  # noqa: E501
        :rtype: str
        """
        return self._cert_issuer_subject

    @cert_issuer_subject.setter
    def cert_issuer_subject(self, cert_issuer_subject):
    ...
    @property
    def cert_issuer_public_key(self):
        """Gets the cert_issuer_public_key of this TLSInfo.  # noqa: E501

        The base64-url-safe-encoded raw public key bytes of the issuer.   # noqa: E501

        :return: The cert_issuer_public_key of this TLSInfo.  # noqa: E501
        :rtype: str
        """
        return self._cert_issuer_public_key

    @cert_issuer_public_key.setter
    def cert_issuer_public_key(self, cert_issuer_public_key):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TLSInfo):
            return False
