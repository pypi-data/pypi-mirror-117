...
class PluginMount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, description, settable, source, destination, type, options, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, description, settable, source, destination, type, options, *args, **kwargs):  # noqa: E501
        """PluginMount - a model defined in OpenAPI
