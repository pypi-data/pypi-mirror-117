...
class ContainerCreateResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, warnings, *args, **kwargs):  # noqa: E501
        """ContainerCreateResponse - a model defined in OpenAPI
