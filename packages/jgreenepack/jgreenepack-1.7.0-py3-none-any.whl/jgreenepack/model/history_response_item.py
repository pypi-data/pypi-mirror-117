...
class HistoryResponseItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, created, created_by, tags, size, comment, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, created, created_by, tags, size, comment, *args, **kwargs):  # noqa: E501
        """HistoryResponseItem - a model defined in OpenAPI
