...
class EndpointPortConfig(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'published_port': (int,),  # noqa: E501
            'publish_mode': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'published_port': 'PublishedPort',  # noqa: E501
        'publish_mode': 'PublishMode',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            target_port (int): The port inside the container.. [optional]  # noqa: E501
            published_port (int): The port on the swarm hosts.. [optional]  # noqa: E501
            publish_mode (str): The mode in which port is published.  <p><br /></p>  - \"ingress\" makes the target port accessible on every node,   regardless of whether there is a task for the service running on   that node or not. - \"host\" bypasses the routing mesh and publish the port directly on   the swarm node where that service is running. . [optional] if omitted the server will use the default value of "ingress"  # noqa: E501
        """
