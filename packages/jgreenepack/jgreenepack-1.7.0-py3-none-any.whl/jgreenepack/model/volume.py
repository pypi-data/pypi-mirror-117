...
class Volume(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, driver, mountpoint, labels, options, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            scope (str): The level at which the volume exists. Either `global` for cluster-wide, or `local` for machine level. . defaults to "local", must be one of ["local", "global", ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, driver, mountpoint, labels, options, *args, **kwargs):  # noqa: E501
        """Volume - a model defined in OpenAPI
