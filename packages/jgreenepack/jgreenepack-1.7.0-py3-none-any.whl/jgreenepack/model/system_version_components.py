...
class SystemVersionComponents(ModelNormal):
    ...
    def _from_openapi_data(cls, name, version, *args, **kwargs):  # noqa: E501
        """SystemVersionComponents - a model defined in OpenAPI
