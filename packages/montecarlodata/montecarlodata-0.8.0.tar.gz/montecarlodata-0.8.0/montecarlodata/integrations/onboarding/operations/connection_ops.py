...
from montecarlodata.integrations.onboarding.fields import EXPECTED_UPDATE_CREDENTIALS_RESPONSE_FIELD, \
    EXPECTED_REMOVE_CONNECTION_RESPONSE_FIELD, OPERATION_ERROR_VERBIAGE
...
class ConnectionOperationsService(BaseOnboardingService):
    ...
    @manage_errors
    def update_credentials(self, connection_id: UUID, changes: Dict, should_validate: Optional[bool] = True) -> None:
        """
