...
LOCAL_INTEGRATED_FOLDER = ['C:/Users/Public/Documents/Scala/LocalIntegratedContent', 'D:/SCALA/PLAYER_CFG_DATA/Documents/LocalIntegratedContent']

svars = variables()

if svars['Player.local_integrated_folder_on_d']:
    LOCAL_INTEGRATED_FOLDER = LOCAL_INTEGRATED_FOLDER[1]
else:
    LOCAL_INTEGRATED_FOLDER = LOCAL_INTEGRATED_FOLDER[0]    
