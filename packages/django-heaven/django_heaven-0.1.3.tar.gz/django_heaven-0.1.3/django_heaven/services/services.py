...
class Service:
    """ The most base service for the django_heaven. Use that instead of direct model calls """
    model: Model = None    # your django ORM model
    read_only: bool = False  # if you only want to read from that model.
    # May be useful for the read-only models
