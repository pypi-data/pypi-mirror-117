...
setup(
  ...
  long_description='The documentation of this package can be seen in https://github.com/MuhammadArdiPutra/ModuleByArdi.',
  ...
  download_url = 'https://github.com/MuhammadArdiPutra/ModuleByArdi/archive/refs/tags/v_0.31.tar.gz',    # I explain this later on
