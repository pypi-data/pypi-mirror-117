        ...
        **kwargs: Any,
        ...
        Args:
            ...
            config: The configuration of the session.
                If not ``None``, it must be a plain Python object.
    ...
    def _create_distributed_session(
        ...
        **kwargs: Any,
        ...
        Args:
            name: The name of the session.
            config: The configuration of the session.
                If not ``None``, it must be a plain Python object following the structure of :class:`atoti.config.session_config.SessionConfig`.
        """
        self._clear_duplicate_sessions(name)
