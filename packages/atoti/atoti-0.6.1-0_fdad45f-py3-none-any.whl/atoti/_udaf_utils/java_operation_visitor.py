...
class JavaOperation:
    ...
    additional_methods_source_codes: Sequence[str]
...
class IncompatibleColumnsException(Exception):
    def __init__(self, first_type: DataType, second_type: DataType):
        self.message = f"Incompatible column types: {first_type} and {second_type}"
