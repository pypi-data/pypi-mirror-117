...
def create_date_hierarchy(  # pylint: disable=dangerous-default-value
    ...
    *,
    ...
    The new levels are created by matching a date `date pattern <https://docs.oracle.com/en/java/javase/15/docs/api/java.base/java/time/format/DateTimeFormatter.html#patterns>`_.
