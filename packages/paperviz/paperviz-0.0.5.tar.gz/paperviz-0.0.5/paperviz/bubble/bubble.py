...
class Bubble:
    def read_file(self, file):
      ...
      # For example: 'file.csv' will return 'application/vnd.ms-excel'
    ...
    def bubble_plot(self, file, x_col_name, y_col_name, bubble_col, x_label,
        ...
        # plot bubble chart
        scatter = ax.scatter(x=data[x_col_name[0]].tolist(),
                             y=data[y_col_name[0]].tolist(),
                             c=colors,
                             s=bubble_scale,
        ...
        for i in range(0, num_index):
            l.append(
                mpatches.Patch(color=colors[i],
                               ...
                               label=legend_list[i]))
        # legend
        legend1 = ax.legend(handles=l, title=legend_title,fontsize=conf['legend_size'],loc=conf['legend_loc'])
