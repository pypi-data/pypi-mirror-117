...
# example on how to load DLL from a specified directory
#sio = LIBUSBSIO(r"..\..\bin_debug\x64", loglevel=logging.DEBUG)
#sio = LIBUSBSIO("../../bin_debug/osx", loglevel=logging.DEBUG)
#sio = LIBUSBSIO("../../bin_debug/linux", loglevel=logging.DEBUG)
#sio = LIBUSBSIO("../../bin_debug/linux32", loglevel=logging.DEBUG)

# load DLL from default directory
sio = LIBUSBSIO(loglevel=logging.DEBUG)

# SPI SSEL port.pin
spi_ssel = (0, 15)  # port 0.15 used by LPCLink2. The MCULink Pro ignores it so it is good too
