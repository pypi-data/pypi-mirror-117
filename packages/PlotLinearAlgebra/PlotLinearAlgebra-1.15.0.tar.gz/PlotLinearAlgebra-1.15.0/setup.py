...
setup(
    ...
    version=VERSION,
    license=read("LICENSE.txt", is_encoding=False, ignore_raises=True),
    packages=find_packages(),
    description='Herramienta para la visualización bidimensional y tridimensional de objetos geométricos abordados en álgebra lineal',
    ...
    download_url='https://github.com/josorio398/ALGEBRA-LINEAL-CON-PYTHON/blob/master/plotvectors.py'.format(
        VERSION),
    keywords=['LinearAlgebra','PlotLinearAlgebra','algebralineal','plot','vectors','lines','planes','point','plotsurface','plotvectors','plotplane','plot2D','plot3D','plotlines',
    'vectorplot','plotpoint','pointplot','plotEquation','planeplot','lineplot'],
    install_requires=[
        'plotly==5.1.0','numpy','sympy','latex'
    ],
