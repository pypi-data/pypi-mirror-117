...
"""
*  This file:/acct/employee/lsipusr/tmp/t2/newIcmScript.py :: [[elisp:(org-cycle)][| ]]
...
####+END:
    ...
    newLibIcmCmnd.commonParamsSpecify(icmParams)        
...
####+END:
        ...
        newLibIcmCmnd.examples_libModuleCmnds()
