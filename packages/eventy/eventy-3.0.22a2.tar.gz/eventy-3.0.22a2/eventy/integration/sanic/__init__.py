...
import eventy.integration.sanic.vendor as vendor_sanic
...
def sanic_correlation_id_provider(request: vendor_sanic.Request) -> None:
    """
...
def sanic_request_id_provider(request: vendor_sanic.Request) -> None:
    """
...
class Sanic(vendor_sanic.Sanic):
    """
