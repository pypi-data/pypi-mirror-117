...
setup(
    ...
    py_modules=[
        ...
        'logger.src.common.configuration.httpClientConfig',
        'logger.src.common.dto',
        'logger.src.common.dto.logCreateDto',
        'logger.src.common.dto.logRequestDto',
        'logger.src.common.enums',
        'logger.src.common.enums.logLevel',
        'logger.src.common.enums.platform'
