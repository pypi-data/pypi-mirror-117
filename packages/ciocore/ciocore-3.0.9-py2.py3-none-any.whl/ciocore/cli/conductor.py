...
from ciocore import downloader_linux_daemon, downloader_orig, uploader, loggeria, config
...
def run_downloader(args):
    ...
    if sys.platform == "win32":
        return downloader_orig.run_downloader(args_dict)
    ...
    if args_dict.get("job_id") or args_dict.get("alt"):
        ...
        return downloader_linux_daemon.run_downloader(args_dict)
