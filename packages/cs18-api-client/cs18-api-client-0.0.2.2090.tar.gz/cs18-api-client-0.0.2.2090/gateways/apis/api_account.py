...
class ApiAccount(ApiBase):
    ...
    def submit_new_user_survey(self, account_id: str) -> str:
        return self.build_route(f"accounts/{account_id}/roles_and_technologies")

    def is_new_user_survey_taken(self, account_id: str) -> str:
        return self.build_route(f"accounts/{account_id}/survey_taken")
