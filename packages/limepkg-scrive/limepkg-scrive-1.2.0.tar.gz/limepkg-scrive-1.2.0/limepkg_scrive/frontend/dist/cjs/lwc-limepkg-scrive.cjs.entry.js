...
const core = require('./core-cc8d68df.js');
...
const Test = class {
    ...
    render() {
        ...
        return (core.h("div", { class: "container" }, core.h("limel-config", { config: { iconPath: '/static/limepkg_scrive/static/' } }), core.h("limel-button", { label: label, outlined: true, icon: "scrive", onClick: () => this.goToScrive(this.context.id) }), core.h("p", null, "Once the document is fully e-signed, the attached document will be replaced with the e-signed copy. If you would rather keep the original document, please clone this document and e-sign the clone.")));
    }
