...
export class Test {
    ...
    render() {
        ...
        return (h("div", { class: "container" },
            ...
            h("p", null, "Once the document is fully e-signed, the attached document will be replaced with the e-signed copy. If you would rather keep the original document, please clone this document and e-sign the clone.")));
    }
