...
class Connector:
    ...
    def get_factor_list(self, api_key):
    ...
    def get_my_wit_list(self, api_key):
    ...
    def register_my_wit(self, api_key, wit, title, description):
    ...
    def get_my_wit(self, api_key, wit_id):
        response = Connector.get_wit_descriptor(api_key, wit_id)

        return response['wit']

    def get_my_wit_descriptor(self, api_key, wit_id):
    ...
    def delete_my_wit(self, api_key, wit_id):
