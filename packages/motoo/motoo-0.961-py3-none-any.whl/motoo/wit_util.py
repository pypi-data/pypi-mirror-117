...
class Connector:
    ...
    @staticmethod
    def register_my_wit(api_key, wit, title, description):
    ...
    @staticmethod
    def get_my_wit(api_key, wit_id):
        response = Connector.get_wit_descriptor(api_key, wit_id)

        return response['wit']

    @staticmethod
    def get_my_wit_descriptor(api_key, wit_id):
    ...
    @staticmethod
    def delete_my_wit(api_key, wit_id):
