...
class Connector:
    ...
    register_api_url = 'https://9a11r8vjs7.execute-api.ap-northeast-2.amazonaws.com/Prod/wit'
    get_api_url = 'https://swxvc99i7g.execute-api.ap-northeast-2.amazonaws.com/Prod/wit'
    delete_api_url = 'https://kpfpss04bd.execute-api.ap-northeast-2.amazonaws.com/Prod/wit'

    @staticmethod
    def register_wit(api_key, wit, title, description):
        ...
        response = requests.post(Connector.register_api_url, data=json.dumps(data)).text
        
        return response

    @staticmethod
    def get_wit(api_key, wit_id):
        response = Connector.get_wit_descriptor(api_key, wit_id)
    ...
    def get_wit_descriptor(api_key, wit_id):
        ...
        data['apiKey'] = api_key
        data['witId'] = wit_id
        response = requests.post(Connector.get_api_url, data=json.dumps(data)).json()
    ...
    @staticmethod
    def delete_wit(api_key, wit_id):
        data = dict()
        data['apiKey'] = api_key
        data['witId'] = wit_id
        response = requests.post(Connector.delete_api_url, data=json.dumps(data)).text
