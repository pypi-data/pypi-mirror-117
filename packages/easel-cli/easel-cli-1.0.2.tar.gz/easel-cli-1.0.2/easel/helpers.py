...
def load_db():
    # TODO: since this just silently creates a db if it doesn't exist, it's
    # easy to pollute the directories with tons of empty dbs. if it doesn't
    # exist, we probably don't want to run the command anyway so should we just
