...
from azureml.data.constants import _TELEMETRY_ENTRY_POINT_DATASET, _PARTITION_KEYS, _PATITION_KEY_VALUES_ACTIVITY
...
class AbstractDataset(object):
    ...
    def partition_keys(self):
        ...
        """
        if self._properties[_PARTITION_KEYS] is None:
            return []
        return self._properties.get(_PARTITION_KEYS, None)
