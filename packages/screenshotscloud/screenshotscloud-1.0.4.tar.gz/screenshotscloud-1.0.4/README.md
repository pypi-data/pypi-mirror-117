[![Build Status](https://travis-ci.org/ScreenshotsCloud/screenshotscloud-python.svg?branch=master)](https://travis-ci.org/ScreenshotsCloud/screenshotscloud-python)
