...
def get_xml_object(xml_text):
    ...
    if carta_porte.exists:
        ...
        carta_porte_dic["autotransportefederal"] = autotransporte_federal.to_dict()
        carta_porte_dic["autotransportefederal"]["identificacionvehicular"] = autotransporte_federal.find("identificacionvehicular").to_dict()
