...
def get_xml_object(xml_text):
    ...
    if carta_porte.exists:
        ...
        for mercancia in  carta_porte.find("mercancias").find_list("ubicacion"):
            mercancia_dic = mercancia.to_dict()
            mercancia_dic["mercancia"] = ucp.find("mercancia").to_dict()
            mercancia_dic["autotransportefederal"] = ucp.find("autotransportefederal").to_dict()
            mercancia_dic["autotransportefederal"]["identificacionvehicular"] = ucp.find("autotransportefederal").find("identificacionvehicular").to_dict()
