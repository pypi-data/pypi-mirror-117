...
_ASSEMBLYDATASETDESCRIPTOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='gc_count', full_name='ncbi.datasets.v1.AssemblyDatasetDescriptor.gc_count', index=16,
...
_VIRUSDATASETREQUEST_ACCESSIONS = _descriptor.Descriptor(
  name='Accessions',
  full_name='ncbi.datasets.v1.VirusDatasetRequest.Accessions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='accessions', full_name='ncbi.datasets.v1.VirusDatasetRequest.Accessions.accessions', index=0,
      number=1, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DATASETREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='genome', full_name='ncbi.datasets.v1.DatasetRequest.genome', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='gene', full_name='ncbi.datasets.v1.DatasetRequest.gene', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='gene', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='virus', full_name='ncbi.datasets.v1.DatasetRequest.virus', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
VirusDatasetRequest = _reflection.GeneratedProtocolMessageType('VirusDatasetRequest', (_message.Message,), {
  ...
  'Accessions' : _reflection.GeneratedProtocolMessageType('Accessions', (_message.Message,), {
    ...
    '__module__' : 'ncbi.datasets.v1.datasets_pb2'
    # @@protoc_insertion_point(class_scope:ncbi.datasets.v1.VirusDatasetRequest.Accessions)
    })
  ,
