...
from ncbi.datasets.openapi.model.v1_gene_dataset_request_gene_ids import V1GeneDatasetRequestGeneIds
from ncbi.datasets.openapi.model.v1_gene_dataset_request_gene_ids import V1GeneDatasetRequestGeneIds as V1alpha1GeneDatasetRequestGeneIds
...
from ncbi.datasets.openapi.model.v1_micro_bigge_dataset_request_element_flank_config import V1MicroBiggeDatasetRequestElementFlankConfig
from ncbi.datasets.openapi.model.v1_micro_bigge_dataset_request_element_flank_config import V1MicroBiggeDatasetRequestElementFlankConfig as V1alpha1MicroBiggeDatasetRequestElementFlankConfig
...
from ncbi.datasets.openapi.model.v1_virus_dataset_request_accessions import V1VirusDatasetRequestAccessions
from ncbi.datasets.openapi.model.v1_virus_dataset_request_accessions import V1VirusDatasetRequestAccessions as V1alpha1VirusDatasetRequestAccessions
