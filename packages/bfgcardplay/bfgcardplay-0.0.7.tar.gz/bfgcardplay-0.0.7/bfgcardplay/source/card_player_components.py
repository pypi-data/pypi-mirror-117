...
class SelectedSuit(Suit):
    ...
    def __init__(self, name: Union[str, None]=None, selection_reason: str='000', *args, **kwargs):
...
class SelectedCard(Card):
    ...
    def __init__(self, card: Card, selection_reason:str='000', *args, **kwargs):
        super().__init__(card.name, *args, **kwargs)
