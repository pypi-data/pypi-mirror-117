...
from bridgeobjects import SUITS, Suit, Spades, Hearts, Diamonds, Clubs, SEATS, Contract, Denomination, Call, Board
from .card_player_components import SelectedSuit, Card


def opening_lead_suit(board: Board) -> Suit:
...
class OpeningLeadSuit():
    ...
    def _allocate_bids(self) -> Tuple[List[Call], List[Call], List[Call], List[Call], List[Call]]:
        ...
        for index, call in enumerate(auction.calls):
            ...
            if self.contract.trump_suit:
                if call == Call('4NT') or call == Call('5NT'):
                    skip_call = index + 2
            if call.is_value_call and not index == skip_call:
    ...
    def _opening_lead_suit(self) -> Suit:
    ...
    def _stayman_suits(self) -> List[Suit]:
        """Return the suits implied by stayman bids."""
        opponents_suits: List[Suit] = []
        ...
        if self.opponents_bids[2].denomination == Hearts():
            return [Hearts()]
        raise AttributeError ('No Suit returned for Stayman bids')


    def _unbid_suits(self) -> List[Suit]:
    ...
    def _select_suit_for_nt_slam_contract(self) -> Union[SelectedSuit, None]:
    ...
    def _select_suit_for_preempt_nt_contract(self) -> SelectedSuit:
    ...
    def _select_suit_for_informed_nt_contract(self) -> Suit:
    ...
    def _biddable_major(self, suit_length: int) -> Union[SelectedSuit, None]:
    ...
    def _biddable_suit(self, suit_length: int) -> Union[SelectedSuit, None]:
    ...
    def _select_suit_for_blind_nt_contract(self) -> SelectedSuit:
    ...
    def _select_long_suit_for_blind_nt_contract(self) -> SelectedSuit:
    ...
    def _select_four_card_suit_for_blind_nt_contract(self) -> SelectedSuit:
    ...
    def _select_best_four_card_suit(self) -> SelectedSuit:
    ...
    def _select_from_equal_long_suits(self, long_suits: List[SelectedSuit]) -> SelectedSuit:
    ...
    def _remove_tenaces(self, candidate_suits: List[SelectedSuit]) -> List[SelectedSuit]:
    ...
    def _most_honours(self, suit_list: List[SelectedSuit]) -> int:
    ...
    def _suits_with_most_honours(self, suit_list: List[SelectedSuit], most_honours: int) -> List[SelectedSuit]:
    ...
    def _best_of_long_suits_with_honours(self, suit_list: List[SelectedSuit]) -> SelectedSuit:
    ...
    def _equal_long_suits(self) -> List[SelectedSuit]:
    ...
    def _most_honour_points(self, suit_list: List[SelectedSuit]) -> int:
    ...
    def _suits_with_honour_points(self, suit_list: List[SelectedSuit], max_honour_points: int) -> List[SelectedSuit]:
    ...
    def _best_suit_with_sequence(self) -> Union[Suit, None]:
    ...
    def _best_suit_with_near_sequence(self) -> Union[Suit, None]:
    ...
    def _best_suit_with_interior_sequence(self) -> Union[Suit, None]:
    ...
    def _non_ace_suits(self, suit_list: List[SelectedSuit]) -> List[SelectedSuit]:
    ...
    def _highest_suit_value(self, suit_list: List[SelectedSuit]) -> int:
    ...
    def _get_suits_with_value(self, suit_list: List[SelectedSuit], max_value: int) -> List[SelectedSuit]:
    ...
    def _select_suit_for_suit_contract(self) -> Union[List[SelectedSuit], None]:
        ...
        if self._no_selected_suit_or_no_cards(selected_suit):
            ...
            raise AttributeError('No suit found for suit contract.')
        return selected_suit

    def _defend_against_slam(self) -> Union[SelectedSuit, None]:
    ...
    def _no_selected_suit_or_no_cards(self, selected_suit: Union[SelectedSuit, None]) -> bool:
    ...
    def _suit_with_sequence(self) -> Union[SelectedSuit, None]:
    ...
    def _trump_after_double(self) -> Union[SelectedSuit, None]:
    ...
    def _dummy_has_long_suit(self) -> Union[SelectedSuit, None]:
    ...
    def _suit_with_AK(self) -> Union[SelectedSuit, None]:
    ...
    def _suit_with_singleton(self) -> Union[SelectedSuit, None]:
    ...
    def _suit_bid_by_partner(self) -> Union[SelectedSuit, None]:
    ...
    def _suit_if_not_deprecated(self) -> Union[SelectedSuit, None]:
    ...
    def _suit_has_two_honours(self, suit: Suit, cards: List[Card]) -> bool:
    ...
    def _non_deprecated_suits(self) -> List[Suit]:
    ...
    def _use_trumps(self) -> Union[SelectedSuit, None]:
    ...
    def _get_best_sequence_suit(self, sequences: Dict[Suit, Card]) -> Union[SelectedSuit, None]:
    ...
    def _get_top_card_in_sequences(self, sequences: Dict[Suit, Card]) -> Card:
    ...
    def _get_candidate_sequence_suits(self, sequences: Dict[Suit, Card], top_of_sequence: Card) -> List[Suit]:
    ...
    def _get_best_suit_for_equal_rank_sequences(self, candidate_suits: List[Suit]) -> Union[SelectedSuit, None]:
        ...
        if len(suit_candidates) > 1:
            suit = self._get_suit_with_highest_value(suit_candidates)
            return suit
        return None

    def _get_suit_with_highest_value(self, suit_candidates) -> SelectedSuit:
    ...
    def _touching_honours(self) -> Union[SelectedSuit, None]:
    ...
    def _partners_shortage(self) -> Union[SelectedSuit, None]:
    ...
    def _best_of_poor_suits(self) -> Union[SelectedSuit, None]:
        """Select best suit from poor choices."""
        suits = [Suit(suit) for suit in SUITS if Suit(suit) not in self.opponents_suits]
        deprecated_suits = []
        for suit in suits:
            cards = self.hand.cards_by_suit[suit.name]
            if cards[0].rank == 'A' and cards[1].rank != 'K':
