...
class Tim:
  ...
  def create_forecast(
      self, dataset_id: str, job_configuration: Union[CreateForecastConfiguration, None] = None
  ) -> str:
    ...
    job_configuration : CreateForecastConfiguration, Optional
    ...
    job_configuration_with_use_case_id = ForecastJobConfiguration(useCaseId=created_use_case_id)

    if job_configuration:
      if 'name' in job_configuration: job_configuration_with_use_case_id['name'] = job_configuration['name']
      if 'configuration' in job_configuration:
        job_configuration_with_use_case_id['configuration'] = job_configuration['configuration']
      if 'data' in job_configuration: job_configuration_with_use_case_id['data'] = job_configuration['data']
