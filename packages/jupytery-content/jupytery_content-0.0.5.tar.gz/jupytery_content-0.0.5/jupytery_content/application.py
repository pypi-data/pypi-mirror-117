...
class JupyterContentApp(ExtensionAppJinjaMixin, ExtensionApp):

    # The name of the extension.
    name = "jupytery_content"

    # The url that your extension will serve its homepage.
    extension_url = '/jupytery_content/default'
    ...
    def initialize_settings(self):
        self.log.info('JupyterContent Config {}'.format(self.config))
