"""Initial source code for the Jupytery Content Manager taken from https://github.com/src-d/jgscm under MIT License https://github.com/datalayer-externals/jgscm/blob/65ee2fe74d2db05b0873ee9e39af42925fc0ea83/LICENSE.md
...
class GoogleStorageCheckpoints(GenericCheckpointsMixin, Checkpoints):
    ...
    def get_notebook_checkpoint(self, checkpoint_id, path):
        """Get the content of a checkpoint for a jupyter_server.
