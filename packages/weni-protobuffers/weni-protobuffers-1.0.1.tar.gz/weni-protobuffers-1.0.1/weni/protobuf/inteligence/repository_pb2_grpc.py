...
class RepositoryControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.List = channel.unary_stream(
                ...
                request_serializer=repository__pb2.RepositoryListRequest.SerializeToString,
                response_deserializer=repository__pb2.Repository.FromString,
                )
        self.RetrieveAuthorization = channel.unary_unary(
                '/weni.bothub.repository.RepositoryController/RetrieveAuthorization',
                request_serializer=repository__pb2.RepositoryAuthorizationRetrieveRequest.SerializeToString,
                response_deserializer=repository__pb2.Repository.FromString,
                )
...
def add_RepositoryControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'List': grpc.unary_stream_rpc_method_handler(
                    servicer.List,
                    request_deserializer=repository__pb2.RepositoryListRequest.FromString,
                    response_serializer=repository__pb2.Repository.SerializeToString,
            ),
            'RetrieveAuthorization': grpc.unary_unary_rpc_method_handler(
                    servicer.RetrieveAuthorization,
                    request_deserializer=repository__pb2.RepositoryAuthorizationRetrieveRequest.FromString,
                    response_serializer=repository__pb2.Repository.SerializeToString,
            ),
    }
...
class RepositoryController(object):
    ...
    def List(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/weni.bothub.repository.RepositoryController/List',
            repository__pb2.RepositoryListRequest.SerializeToString,
            repository__pb2.Repository.FromString,
    ...
    def RetrieveAuthorization(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/weni.bothub.repository.RepositoryController/RetrieveAuthorization',
            repository__pb2.RepositoryAuthorizationRetrieveRequest.SerializeToString,
            repository__pb2.Repository.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
