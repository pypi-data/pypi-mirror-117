...
class BillingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Detailed = channel.unary_stream(
                ...
                request_serializer=billing__pb2.BillingRequest.SerializeToString,
                response_deserializer=billing__pb2.ActiveContactDetail.FromString,
                )
...
def add_BillingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Detailed': grpc.unary_stream_rpc_method_handler(
                    servicer.Detailed,
                    request_deserializer=billing__pb2.BillingRequest.FromString,
                    response_serializer=billing__pb2.ActiveContactDetail.SerializeToString,
            ),
    }
...
class Billing(object):
    ...
    def Detailed(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/weni.rapidpro.billing.Billing/Detailed',
            billing__pb2.BillingRequest.SerializeToString,
            billing__pb2.ActiveContactDetail.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
