...
class UserControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Update = channel.unary_unary(
                ...
                request_serializer=user__pb2.UpdateUserLang.SerializeToString,
                response_deserializer=user__pb2.User.FromString,
                )
...
def add_UserControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Update': grpc.unary_unary_rpc_method_handler(
                    servicer.Update,
                    request_deserializer=user__pb2.UpdateUserLang.FromString,
                    response_serializer=user__pb2.User.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class UserController(object):
    ...
    def Update(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/weni.rapidpro.user.UserController/Update',
            user__pb2.UpdateUserLang.SerializeToString,
            user__pb2.User.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
