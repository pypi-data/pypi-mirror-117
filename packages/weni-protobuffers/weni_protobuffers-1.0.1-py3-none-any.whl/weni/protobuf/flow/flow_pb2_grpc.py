...
class FlowControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.List = channel.unary_stream(
                ...
                request_serializer=flow__pb2.FlowListRequest.SerializeToString,
                response_deserializer=flow__pb2.Flow.FromString,
                )
...
def add_FlowControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'List': grpc.unary_stream_rpc_method_handler(
                    servicer.List,
                    request_deserializer=flow__pb2.FlowListRequest.FromString,
                    response_serializer=flow__pb2.Flow.SerializeToString,
            ),
    }
...
class FlowController(object):
    ...
    def List(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/weni.rapidpro.flow.FlowController/List',
            flow__pb2.FlowListRequest.SerializeToString,
            flow__pb2.Flow.FromString,
