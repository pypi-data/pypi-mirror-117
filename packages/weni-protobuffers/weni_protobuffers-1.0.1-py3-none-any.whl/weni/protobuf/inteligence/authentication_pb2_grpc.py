...
class UserPermissionControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Retrieve = channel.unary_unary(
                ...
                request_serializer=authentication__pb2.UserPermissionRetrieveRequest.SerializeToString,
                response_deserializer=authentication__pb2.Permission.FromString,
                )
        self.Update = channel.unary_unary(
                '/weni.bothub.authentication.UserPermissionController/Update',
                request_serializer=authentication__pb2.UserPermissionUpdateRequest.SerializeToString,
                response_deserializer=authentication__pb2.Permission.FromString,
                )
        self.Remove = channel.unary_unary(
                '/weni.bothub.authentication.UserPermissionController/Remove',
                request_serializer=authentication__pb2.UserPermissionRemoveRequest.SerializeToString,
...
def add_UserPermissionControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Retrieve': grpc.unary_unary_rpc_method_handler(
                    servicer.Retrieve,
                    request_deserializer=authentication__pb2.UserPermissionRetrieveRequest.FromString,
                    response_serializer=authentication__pb2.Permission.SerializeToString,
            ),
            'Update': grpc.unary_unary_rpc_method_handler(
                    servicer.Update,
                    request_deserializer=authentication__pb2.UserPermissionUpdateRequest.FromString,
                    response_serializer=authentication__pb2.Permission.SerializeToString,
            ),
            'Remove': grpc.unary_unary_rpc_method_handler(
                    servicer.Remove,
                    request_deserializer=authentication__pb2.UserPermissionRemoveRequest.FromString,
...
class UserPermissionController(object):
    ...
    def Retrieve(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/weni.bothub.authentication.UserPermissionController/Retrieve',
            authentication__pb2.UserPermissionRetrieveRequest.SerializeToString,
            authentication__pb2.Permission.FromString,
    ...
    def Update(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/weni.bothub.authentication.UserPermissionController/Update',
            authentication__pb2.UserPermissionUpdateRequest.SerializeToString,
            authentication__pb2.Permission.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Remove(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/weni.bothub.authentication.UserPermissionController/Remove',
            authentication__pb2.UserPermissionRemoveRequest.SerializeToString,
...
class UserControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Retrieve = channel.unary_unary(
                ...
                request_serializer=authentication__pb2.UserRetrieveRequest.SerializeToString,
                response_deserializer=authentication__pb2.User.FromString,
                )
...
def add_UserControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Retrieve': grpc.unary_unary_rpc_method_handler(
                    servicer.Retrieve,
                    request_deserializer=authentication__pb2.UserRetrieveRequest.FromString,
                    response_serializer=authentication__pb2.User.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class UserController(object):
    ...
    def Retrieve(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/weni.bothub.authentication.UserController/Retrieve',
            authentication__pb2.UserRetrieveRequest.SerializeToString,
            authentication__pb2.User.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
...
class UserLanguageControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Update = channel.unary_unary(
                ...
                request_serializer=authentication__pb2.UserLanguageUpdateRequest.SerializeToString,
                response_deserializer=authentication__pb2.User.FromString,
                )
...
def add_UserLanguageControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Update': grpc.unary_unary_rpc_method_handler(
                    servicer.Update,
                    request_deserializer=authentication__pb2.UserLanguageUpdateRequest.FromString,
                    response_serializer=authentication__pb2.User.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class UserLanguageController(object):
    ...
    def Update(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/weni.bothub.authentication.UserLanguageController/Update',
            authentication__pb2.UserLanguageUpdateRequest.SerializeToString,
            authentication__pb2.User.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
