...
def cal_g160(cleanFile,inFile,outFile,inOffset,outOffset,maxComNLevel=c_double(-48.0),speechPauseLevel=c_double(-35.0)):
    """
    ...
    mydll.Noise_Compute(cleFile,inputFile,outputFile,inOffset,outOffset,maxComNLevel,speechPauseLevel,byref(g160))
