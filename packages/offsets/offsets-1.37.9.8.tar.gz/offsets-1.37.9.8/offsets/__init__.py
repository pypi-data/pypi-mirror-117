class csgo:
    ...
    dwGameDir = (0x627780)
    dwGameRulesProxy = (0x52C02CC)
    dwGetAllClasses = (0xDB202C)
    dwGlobalVars = (0x588CF0)
    dwGlowObjectManager = (0x52EB658)
    dwInput = (0x51F47B0)
    dwInterfaceLinkList = (0x945344)
    dwLocalPlayer = (0xD8A2DC)
    dwMouseEnable = (0xD8FE28)
    dwMouseEnablePtr = (0xD8FDF8)
    dwPlayerResource = (0x31D1AA0)
    dwRadarBase = (0x51D7F64)
    dwSensitivity = (0xD8FCC4)
    dwSensitivityPtr = (0xD8FC98)
    dwSetClanTag = (0x8A1B0)
    dwViewMatrix = (0x4D94B04)
    dwWeaponTable = (0x51F5270)
    dwWeaponTableIndex = (0x325C)
    dwYawPtr = (0xD8FA88)
    dwZoomSensitivityRatioPtr = (0xD94D28)
    dwbSendPackets = (0xD779A)
    dwppDirect3DDevice9 = (0xA7050)
    find_hud_element = (0x2E75F720)
    ...
    m_pStudioHdr = (0x294C)
    m_pitchClassPtr = (0x51D8200)
    m_yawClassPtr = (0xD8FA88)
