...
class Definition(BaseDefinition):
    def __init__(
        ...
        *,
        ...
        super().__init__(tag=tag, layout=layout, underlying_type=UnderlyingType.CAP)
        self.calculation_params = calculation_params
        self.underlying_definition = CapUnderlyingDefinition(
    ...
    def underlying_definition(self):
        ...
        return self._get_object_parameter(
            CapUnderlyingDefinition, "underlyingDefinition"
        )

    @underlying_definition.setter
    def underlying_definition(self, value):
        self._set_object_parameter(
            CapUnderlyingDefinition, "underlyingDefinition", value
        )
