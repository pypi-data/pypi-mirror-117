...
from openlxp_xia.management.utils.metadata_overwrite \
    import get_metadata_fields_to_fill
...
class XIAConfiguration(TimeStampedModel):
    ...
    def save(self, *args, **kwargs):
        ...
        required_source_list = \
            get_metadata_fields_to_fill(self.source_target_mapping,
                                        self.target_metadata_schema)
        # saving required column values to be overwritten
        for item in required_source_list:
            MetadataFieldOverwrite.field_name = item
            MetadataFieldOverwrite.save()
