...
def validate_source_using_key(source_data_dict, required_column_list,
    ...
    for ind in range(len_source_metadata):
        ...
        # assigning the present metadata instance to add default values
        ...
        for item in required_column_list:
            source_metadata = source_data_dict[ind]['source_metadata']
            ...
            if item in flattened_source_data:
                if not flattened_source_data[item]:
                    ...
                    #         if split_items[index1] in source_metadata:
                    #             source_metadata = source_metadata[
                    #                 split_items[index1]]
                    #         else:
                    #             source_metadata[split_items[index1]] = {}
                    #             source_metadata = source_metadata[
                    #                 split_items[index1]]
                    #     source_metadata[
                ...
                #     else:
                #         source_metadata[split_items[index1]] = {}
                #        source_metadata = source_metadata[split_items[index1]]
                # source_metadata[
                #     split_items[len_split_items - 1]] = 'Unavailable'
                # commented out code for validation
                validation_result = 'N'
