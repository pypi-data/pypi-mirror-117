...
import ForceSpectroscopyHelper.filter_1d as filter_1d
import ForceSpectroscopyHelper.filter_2d as filter_2d
...
def frequency_shift_to_normalized_frequency_shift(delta_f, param: measurement_param) -> np.ndarray:
    ...
    :return:
    """
    return delta_f * param.k * param.amp ** 1.5 / param.f0
