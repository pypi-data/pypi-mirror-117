...
class ResponseError(Error):
    ...
    def factory(resp):
        ...
        All errors are documented: https://docs.liquichain.com/guides/handling-errors#all-possible-status-codes
...
class APIDeprecationWarning(DeprecationWarning):
    """
    Features that are deprecated in the Liquichain API.
