...
***
## <an id="what">What Classes are present in this Library?</a>
- [Email](#email)
- [Whatsapp](#whatsapp)
...
### <an id="email-what">B. What Methods do we Offer?</a>
- Email Class
    - [send_mails](#mails)

### <an id="email-import">C. Importing and assigning Email class</a>
...
### <an id="whatsapp-what">B. What Methods Do we have?</a>
- Whatsapp Class
    - [spam_bot](#spam)
        \
    &nbsp;
...
\
&nbsp;
### <an id="whatsapp-import">C. Importing and assigning Email class</a>
