            ...
            if (max_or_wgt == 'wgtJ_out_dict'):
                ...
                if (cur_stat == 'mean'):
                    ...
                    if (pc_ctr == 0):
                        ...
                        simu_moments_output_agg_mean_wgted = {
                            key: simu_moments_output_agg_mean[key] * cur_weight + simu_moments_output_agg_mean_wgted[
                                key]
                            for key, val in simu_moments_output_agg_mean.items()}
                if (cur_stat == 'var'):
                    ...
                    if (pc_ctr == 0):
                        ...
                        simu_moments_output_agg_var_wgted = {
                            key: simu_moments_output_agg_var[key] * cur_weight + simu_moments_output_agg_var_wgted[key]
                            for key, val in simu_moments_output_agg_var.items()}
