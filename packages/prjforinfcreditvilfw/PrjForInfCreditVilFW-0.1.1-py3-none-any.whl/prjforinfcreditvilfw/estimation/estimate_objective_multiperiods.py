...
def estimate_objective_multiperiods(
    ...
    for period in period_keys_esti_set:
        ...
        #             print('param_dict_moments:', param_dict_moments)
        #             print(param_dict_moments)
        ...
        #             param_dict_moments = wgtJ_out_dict['param_dict_moments']
            ...
            non-period specific version of the key.
                - BUG: REPLACE IS WRONG, leads to time specific parameter from first time period
                not updating
                - NEW: do not replace, ADD TO LIST
            '''
...
def mpoly_predict_moment(param_esti_group_key_list, params_esti,
    ...
    '''
    1. Check locally, EC2 or own computer if the file is there    
        ...
        folder. 
            \data\esti\e_20201025x_esr_medtst_list_tKap_mlt_ce1a2 
        
        
        folder = '' + d_root + bucket_name + '/esti/' + combo_type_list_ab_date    
    #     folder = 'C:/Users/fan/Documents/Dropbox (UH-ECON)/Project Dissertation EC2/thaijmp201809j8vara/esti/c_20180925_ITG_list_Afx3_mlt_ce1a2/'                                                                                                           
        file_name = combo_type_list_ab_date + proj_hardcode_filename.sync_glob_esti_file_suffix(file_type = '_mpoly_reg_coef') 
    #     file_name = 'c_20180925_ITG_list_Afx3_mlt_ce1a2_mpoly_reg_coef'
        folder_file_name = folder +  '/' + file_name + '.csv'    
    '''

    # esti_folder = proj_sys_sup.get_paths(main_folder_name='esti')
    ...
    mpoly_coef_list = []
    counter = 0
    #     for period_key in period_keys_esti_set:
