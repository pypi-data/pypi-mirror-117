...
def get_agg_stats_param_loop_cates01(pd_file,
    ...
    #     pd_file_equi_out = pd_file_sort_select[[x_var_name, equi_gap_var,
    #                                                'esti_param.R_INFORM_BORR',
    #                                                aggregate_inf_borrow_col_name,
    #                                                     avg_inf_borrow_ifborr_col_name,
    #                                                aggregate_inf_save_col_name,
    #                                                     avg_inf_save_ifinfsave_col_name,
    #                                                aggregate_netB_col_name,
    #                                                aggregate_K_col_name,
    #                                                p_inf_borrow_col_name,
    #                                                p_inf_save_col_name]]
