...
class LifeTimeUtility():
    ...
    #                 fbibfsis.genfibs_mjall(j, self.ib_i_ktp, self.ib_i_btp)
    #         if (j == 1):
    #             k_tp, b_tp_borr_for, b_tp_borr_inf, b_tp_save_for, b_tp_lend_inf = \
    #                 fbibfsis.genfibs_mjall(j, self.is_i_ktp, self.is_i_btp)
    #
    #         if (j == 2 or j == 102):
    #             k_tp, b_tp_borr_for, b_tp_borr_inf, b_tp_save_for, b_tp_lend_inf = \
    #                 fbibfsis.genfibs_mjall(j, self.fb_f_ktp, self.fb_f_btp)
    #         if (j == 3):
    #             k_tp, b_tp_borr_for, b_tp_borr_inf, b_tp_save_for, b_tp_lend_inf = \
    #                 fbibfsis.genfibs_mjall(j, self.fs_f_ktp, self.fs_f_btp)
    #
    #         if (j == 4 or j == 104):
    #             k_tp, b_tp_borr_for, b_tp_borr_inf, b_tp_save_for, b_tp_lend_inf = \
    #                 fbibfsis.genfibs_mjall(j, self.ibfb_i_ktp, self.ibfb_i_btp, self.param_inst, self.fb_f_max_btp)
    #
    #         if (j == 5 or j == 105):
    #             k_tp, b_tp_borr_for, b_tp_borr_inf, b_tp_save_for, b_tp_lend_inf = \
    #                 fbibfsis.genfibs_mjall(j, self.fbis_i_ktp, self.fbis_i_btp, self.param_inst, self.fb_f_max_btp)
    #
    #         if (j == 6):
    #             k_tp, b_tp_borr_for, b_tp_borr_inf, b_tp_save_for, b_tp_lend_inf = \
    #                 fbibfsis.genfibs_mjall(j, self.none_ktp)
    #
    #
    ...
    def get_utoday(self, info=False, check_scalar=False):
        ...
        #             b_tp_borr_for_stack = np.zeros(self.stack_shape)
        #             b_tp_borr_inf_stack = np.zeros(self.stack_shape)
        #             b_tp_save_for_stack = np.zeros(self.stack_shape)
        #             b_tp_lend_inf_stack = np.zeros(self.stack_shape)
    ...
    def get_ktp_stack(self):
        ...
        #         ktp_stack = np.column_stack((
        #             self.ib_i_ktp, self.is_i_ktp,
        #             self.fb_f_ktp, self.fs_f_ktp,
    ...
    def get_btp_stack(self):
        ...
        #         btp_stack = np.column_stack((
        #             self.ib_i_btp, self.is_i_btp,
        #             self.fb_f_btp, self.fs_f_btp,
