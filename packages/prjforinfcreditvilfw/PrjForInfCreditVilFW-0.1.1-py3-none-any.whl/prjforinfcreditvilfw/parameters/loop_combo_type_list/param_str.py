...
#     if (reverse):
#         if (param_type == 'esti_param'):
#             param_inst_attribute = 'esti_type'
#         if (param_type == 'grid_param'):
#             param_inst_attribute = 'grid_type'
#         if (param_type == 'interpolant'):
#             param_inst_attribute = 'interpolant_type'
#         if (param_type == 'dist_param'):
#             param_inst_attribute = 'dist_type'
#         if (param_type == 'data_param'):
#             param_inst_attribute = 'data_type'
#         return param_inst_attribute
#     else:
#         if (param_inst_attribute == 'esti_type'):
#             param_type = 'esti_param'
#         if (param_inst_attribute == 'grid_type'):
#             param_type = 'grid_param'
#         if (param_inst_attribute == 'interpolant_type'):
#             param_type = 'interpolant'
#         if (param_inst_attribute == 'dist_type'):
#             param_type = 'dist_param'
#         if (param_inst_attribute == 'data_type'):
#             param_type = 'data_param'
#         return param_type
...
def param_str_equi():
    ...
    #     equivalence_keys = {
    #         'BNF_SAVE_P' + peristr(period=1):['BNF_SAVE_P'],
    #         'BNF_BORR_P' + peristr(period=1):['BNF_BORR_P'],
    #         'BNI_LEND_P' + peristr(period=1):['BNI_LEND_P'],
    #         'BNI_BORR_P' + peristr(period=1):['BNI_BORR_P'],
    #         'kappa' + peristr(period=1):['kappa'],
    #
    #         'BNF_SAVE_P' + peristr(period=2):['BNF_SAVE_P'],
    #         'BNF_BORR_P' + peristr(period=2):['BNF_BORR_P'],
    #         'BNI_LEND_P' + peristr(period=2):['BNI_LEND_P'],
    #         'BNI_BORR_P' + peristr(period=2):['BNI_BORR_P'],
    #         'kappa' + peristr(period=2):['kappa'],
    #
    #         'R_INFORM_SAVE' + peristr(period=1):['R_INFORM_SAVE'],
    #         'R_INFORM_BORR' + peristr(period=1):['R_INFORM_BORR'],
    #         'R_FORMAL_SAVE' + peristr(period=1):['R_FORMAL_SAVE'],
    #         'R_FORMAL_BORR' + peristr(period=1):['R_FORMAL_BORR'],
    #
    #         'R_INFORM_SAVE' + peristr(period=2):['R_INFORM_SAVE'],
    #         'R_INFORM_BORR' + peristr(period=2):['R_INFORM_BORR'],
    #         'R_FORMAL_SAVE' + peristr(period=2):['R_FORMAL_SAVE'],
    #         'R_FORMAL_BORR' + peristr(period=2):['R_FORMAL_BORR']
    #         }
...
def param2str():
    ...
    paramstr_dict_esti_param = \
        {'alpha_k': ['_alpk', 'esti_param.alpha_k'],
         ...
         'BNF_SAVE_P' + peristr(period=1): ['_fcfs' + peristr(period=1), 'esti_param.BNF_SAVE_P' + peristr(period=1)],
         'BNF_BORR_P' + peristr(period=1): ['_fcfb' + peristr(period=1), 'esti_param.BNF_BORR_P' + peristr(period=1)],
         'BNI_LEND_P' + peristr(period=1): ['_fcil' + peristr(period=1), 'esti_param.BNI_LEND_P' + peristr(period=1)],
         'BNI_BORR_P' + peristr(period=1): ['_fcib' + peristr(period=1), 'esti_param.BNI_BORR_P' + peristr(period=1)],
         'kappa' + peristr(period=1): ['_kapp' + peristr(period=1), 'esti_param.kappa' + peristr(period=1)],
         'BNF_SAVE_P' + peristr(period=2): ['_fcfs' + peristr(period=2), 'esti_param.BNF_SAVE_P' + peristr(period=2)],
         'BNF_BORR_P' + peristr(period=2): ['_fcfb' + peristr(period=2), 'esti_param.BNF_BORR_P' + peristr(period=2)],
         'BNI_LEND_P' + peristr(period=2): ['_fcil' + peristr(period=2), 'esti_param.BNI_LEND_P' + peristr(period=2)],
         'BNI_BORR_P' + peristr(period=2): ['_fcib' + peristr(period=2), 'esti_param.BNI_BORR_P' + peristr(period=2)],
         'kappa' + peristr(period=2): ['_kapp' + peristr(period=2), 'esti_param.kappa' + peristr(period=2)],
         'BNF_SAVE_P' + peristr(period=3): ['_fcfs' + peristr(period=3), 'esti_param.BNF_SAVE_P' + peristr(period=3)],
         'BNF_BORR_P' + peristr(period=3): ['_fcfb' + peristr(period=3), 'esti_param.BNF_BORR_P' + peristr(period=3)],
         'BNI_LEND_P' + peristr(period=3): ['_fcil' + peristr(period=3), 'esti_param.BNI_LEND_P' + peristr(period=3)],
         'BNI_BORR_P' + peristr(period=3): ['_fcib' + peristr(period=3), 'esti_param.BNI_BORR_P' + peristr(period=3)],
         'kappa' + peristr(period=3): ['_kapp' + peristr(period=3), 'esti_param.kappa' + peristr(period=3)],
         'BNF_SAVE_P' + peristr(period=4): ['_fcfs' + peristr(period=4), 'esti_param.BNF_SAVE_P' + peristr(period=4)],
         'BNF_BORR_P' + peristr(period=4): ['_fcfb' + peristr(period=4), 'esti_param.BNF_BORR_P' + peristr(period=4)],
         'BNI_LEND_P' + peristr(period=4): ['_fcil' + peristr(period=4), 'esti_param.BNI_LEND_P' + peristr(period=4)],
         'BNI_BORR_P' + peristr(period=4): ['_fcib' + peristr(period=4), 'esti_param.BNI_BORR_P' + peristr(period=4)],
