...
def combo_list_auto(combo_type=None,
    ...
    for param_combo_ctr, param_val_dict_combine_set in zip(params_all_combo_ctr_list, params_all_combinations):
        ...
        param_combo[hardcode_estimation.string_estimation()['param_combo_list_ctr_str']['str']] = _c_param_combo_ctr
...
def gen_initial_params_df(param_group_key_list, minmax_f, minmax_t, param_vec_count, param_grid_or_rand):
    ...
    #         support_json.jdump(param_group_key + ':'  + str(ctr), 'param_group_key:ctr', logger=logger.info)
    #         support_json.jdump(param_base_list, 'param_base_list', logger=logger.info)
