...
def minmax_eachchoice(cash, k_tp,
    ...
    for ctr, j in enumerate(choice_set_list):
        ...
        if (j == 7):
            ...
            # =======================================================================
            # fbWthInf_BorrCostsF = minmax_KB_Borrow(DELTA_DEPRE=DELTA_DEPRE, Y_minCst=cash,
            #                             Bstart=BNF_BORR_P_startVal, RB=R_FORMAL_BORR,
            #                             Z=BNI_BORR_P_startVal, RZ=R_INFORM)
            # =======================================================================

        #         if (j == 8):
        #             # 8:26 AM 2/10/2018 this choice is not actualy posssible. if you are arbitraging, can only be optimal to arbitrage fully.
        #             '''
        #             fbWthInf_SaveCostsF, this is the natural borrowing constraint part of the formal borrowinng constraint,
        #             is bounded in genchoices also by (k_tp * borr_constraint_KAPPA)
        #
        #             From the perspective of finding the choice set, there is no difference between formal borrowing and this choice
        #             except that this choice has a higher 'fixed cost' component to be subtracted away, this is not actually true, unlike above
        #             '''
        #             #=======================================================================
        #             # fbWthInf_SaveCostsF = minmax_KB_Borrow(DELTA_DEPRE=DELTA_DEPRE, Y_minCst=cash - BNF_BORR_P - BNI_SAVELEND_P,
        #             #                             Bstart=BNF_BORR_P_startVal, RB=R_FORMAL_BORR,
        #             #                             Z=BNI_LEND_P_startVal, RZ=R_INFORM)
        #             #=======================================================================
        #             Y_minCstHere = cash - BNF_BORR_P - BNI_LEND_P - BNI_LEND_P_startVal / R_INFORM
        #             fbWthInf_SaveCostsF = minmaxfunc.minmax_KB_Borrow(
        #                                 DELTA_DEPRE=DELTA_DEPRE, Y_minCst=Y_minCstHere,
        #                                 Bstart=BNF_BORR_P_startVal, RB=R_FORMAL_BORR)
        #             cur_minmax = fbWthInf_SaveCostsF
        #             #=======================================================================
        #             # fbWthInf_SaveCostsF = minmax_KB_Borrow(DELTA_DEPRE=DELTA_DEPRE, Y_minCst=cash,
        #             #                             Bstart=BNF_BORR_P_startVal, RB=R_FORMAL_BORR,
        #             #                             Z=BNI_LEND_P_startVal, RZ=R_INFORM)
        #             #=======================================================================
