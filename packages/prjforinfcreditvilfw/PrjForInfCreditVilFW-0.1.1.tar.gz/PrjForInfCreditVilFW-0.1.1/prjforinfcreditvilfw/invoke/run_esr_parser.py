...
if __name__ == '__main__':
    ...
    # dc_st_speckey, dc_st_speckey_mpoly, esrf, \
    # it_esti_top_which_max, compute_spec_key, esti_spec_key = \
    #     run_esr_arg_generator(2, awslocal=True, dc_it_execute_type=dc_it_execute_type)
    #
    # print(f'{dc_st_esr_args_compose=}')
    # print(f'{dc_spt_awslocal_esrf_subfolders=}')
    # print(f'{dc_combo_type=}')
    # print(f'{dc_combo_type_component=}')
    # print(f'{dc_st_speckey=}')
    # print(f'{dc_st_speckey_mpoly=}')
    # print(f'{esrf=}')
    # print(f'{it_esti_top_which_max=}')
    # print(f'{compute_spec_key=}')
    # print(f'{esti_spec_key=}')
