...
Copied over from the run.py file, so that the core invoke function can be called by itself. The run.py function only handles command line parameter parsing. 
'''
