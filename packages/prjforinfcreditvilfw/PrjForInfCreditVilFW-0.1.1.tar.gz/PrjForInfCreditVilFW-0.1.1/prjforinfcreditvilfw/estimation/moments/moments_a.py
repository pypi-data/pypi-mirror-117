...
# def multi_period_moment(period_raw_moment_list):
# 
#     moments = {}        
#     for ctr, period in enumerate(paramloopstr.peristr(action='list')):            
#         period_raw = period_raw_moment_list[0]
#         for pkey, pval in period_raw.items():
#             pkey_period = pkey + paramloopstr.peristr(period=period)
#             moments[pkey_period] = pval
#     
#     return moments
