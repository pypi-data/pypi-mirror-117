...
#         df_use[hardcode_estimation.string_estimation()['support_arg.moments_type_regen']['str']] = moments_type
#         df_use[hardcode_estimation.string_estimation()['support_arg.momsets_type_regen']['str']] = momsets_type 
