...
def save_to_tex_do(save_directory, save_name, DATA_PARAM_DICT,
    ...
    for tex_do in tex_do_list:
        ...
        if (save_agg_tex):
            ...
            next_folder_file_imgtab = proj_sys_sup.get_paths('paper.imgtab', sub_folder_name = sub_folder_name) + save_name + tex_do_suffix
            ...
            if (update_compile_folder):                
                ...
                if((tex_do == 'do') and gen_graph_stata and (save_name == 'DATASIMUPROBJ') and (append_or_add == 'a')):
#                     time.sleep(10)
