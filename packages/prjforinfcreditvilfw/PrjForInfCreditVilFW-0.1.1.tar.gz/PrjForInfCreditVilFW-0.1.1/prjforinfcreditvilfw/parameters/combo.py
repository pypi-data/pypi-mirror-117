...
import parameters.paramset.combo_list_e_test_point as combo_e_test_point
import parameters.paramset.combo_list_e_test_grid as combo_e_test_grid
...
def get_combo(combo_type=None, compesti_specs=None):
    ...
    if (combo_type is not None):
        ...
        if combo_type[0] == 'e':
            ...
            #     combo_list = combo_e_test_point.get_combo_list(combo_type, compesti_specs)
            # else:
            #     combo_list = combo_e_test_grid.get_combo_list(combo_type, compesti_specs)
