...
class LocalizationType(object):
    ...
    def __init__(self, attribute_types=None, color_map=None, description=None, drawable=True, dtype=None, grouping_default=True, id=None, line_width=None, media=None, name=None, project=None, visible=True, local_vars_configuration=None):  # noqa: E501
