...
class LocalizationTypeSpec(object):
    ...
    def __init__(self, attribute_types=None, color_map=None, description=None, drawable=True, dtype=None, grouping_default=True, line_width=None, media_types=None, name=None, visible=True, local_vars_configuration=None):  # noqa: E501
