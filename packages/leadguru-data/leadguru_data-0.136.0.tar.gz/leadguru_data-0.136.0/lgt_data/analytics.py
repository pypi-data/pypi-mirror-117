...
def get_date_aggregated_user_analytics(user_id: str = None, started_at: datetime.datetime = None,
                                       ended_at: datetime.datetime = None):
    pipeline = _build_date_aggregated_analytics_pipeline(started_at=started_at, ended_at=ended_at, user_id=user_id)
    proceeded_messages = list(db['user-message-processed'].aggregate(pipeline))

    proceeded_messages_dic = _create_result_dic(started_at, ended_at)
    return _prepare_date_analytics_doc(proceeded_messages, proceeded_messages_dic)
