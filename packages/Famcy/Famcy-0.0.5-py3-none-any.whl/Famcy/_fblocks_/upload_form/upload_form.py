...
class upload_form(Famcy.FamcyBlock):
    ...
    def render_html(self, context, **configs):
        ...
        """ % (style_script, context["id"], context["method"], action, input_html, main_button_html, extra_script, len(context["main_button_name"]), context["id"], index, context["id"], context["id"], context["id"], context["submit_type"], context["id"], action, context["target_id"])
