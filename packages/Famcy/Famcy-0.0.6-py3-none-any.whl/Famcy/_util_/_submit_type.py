...
class SubmitType(object):
	...
	def __init__(self, submit_type=""):
		...
		self.alert_setting = {"alert_type":"alert-primary", "alert_message":"", "alert_position":"prepend"}
		self.block_setting = {"inner_text": "", "extra_script": ""}
		self.tab_setting = {"inner_text": [""], "extra_script": ""}
		self.redirect_setting = {"redirect_url": "main.home"}
	...
	def return_submit_info(self, msg="", script=""):
		...
		elif self.submit_type == "redirect_url":
