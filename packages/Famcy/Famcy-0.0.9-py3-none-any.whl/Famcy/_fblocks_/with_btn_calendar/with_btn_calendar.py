...
class with_btn_calendar(Famcy.FamcyBlock):
    ...
    def render_html(self, context, **configs):
        ...
        """ % (context["id"], context["action"], context["method"], context["title"], context["id"], main_button_html, json.dumps(context), len(context["main_button_name"]), context["id"], context["id"], context["submit_type"], context["id"], context["action"], context["target_id"])
