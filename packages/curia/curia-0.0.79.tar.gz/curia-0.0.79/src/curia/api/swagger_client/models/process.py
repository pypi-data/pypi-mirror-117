...
class Process(object):
    ...
    def __init__(self, id=None, type=None, project_id=None, process_jobs=None, analysis_id=None, analysis=None, config=None, last_updated_by=None, created_at=None, updated_at=None, version=None):  # noqa: E501
    ...
    @property
    def config(self):
        """Gets the config of this Process.  # noqa: E501


        :return: The config of this Process.  # noqa: E501
        :rtype: object
        """
        return self._config
    ...
    def config(self, config):
        """Sets the config of this Process.


        :param config: The config of this Process.  # noqa: E501
        :type: object
        """
