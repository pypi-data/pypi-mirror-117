...
class ProcessJob(object):
    ...
    def __init__(self, id=None, process_id=None, project_id=None, status=None, statuses=None, outputs=None, analysis_job_id=None, analysis_job=None, last_updated_by=None, created_at=None, updated_at=None, version=None):  # noqa: E501
