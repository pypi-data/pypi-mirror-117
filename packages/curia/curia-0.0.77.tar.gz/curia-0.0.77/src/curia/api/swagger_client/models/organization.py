...
class Organization(object):
    ...
    def __init__(self, id=None, name=None, instance_url=None, domain=None, datasets=None, projects=None, organization_settings=None, organization_feature_exclusions=None, organization_feature_category_exclusions=None, databases=None, last_updated_by=None, created_at=None, updated_at=None, version=None):  # noqa: E501
