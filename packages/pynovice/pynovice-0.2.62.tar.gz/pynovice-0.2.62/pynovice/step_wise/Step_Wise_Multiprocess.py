...
class Regression():
    def __init__(self, X:pd.DataFrame, Y, init_in_vars=[], model=None, sample_weight = None, max_related_level=1, iter_num=20,
                 is_train_test_split=True, test_size=0.4, split_num=10, kw_measure_args={},
                 measure = 'ks',perf_toler=1, max_pvalue_limit=0.05, max_vif_limit=10, max_corr_limit=0.6,seed=666,
                n_core=None, logger_info=True, logger_file=None):
        ...
        self.seed=seed
        self.in_vars=init_in_vars
        self.perf_toler=perf_toler #提升误差容忍度，默认为1，建议在0.95~1之间
    ...
    def _check(self, in_vars, current_perf):
        ...
        check_perf = perfs > current_perf*self.perf_toler
