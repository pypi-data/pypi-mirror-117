...
try:
    ...
    pass
from .utils import _colors as colors
from .utils._utils import safe_isinstance, convert_ordering, convert_color, merge_nodes, get_sort_order, sort_inds
from .utils._explanation import Explanation
...
def beeswarm(shap_values, max_display=10, order=Explanation.abs.mean(0),
             ...
             color_bar=True, plot_size="auto", color_bar_label="Feature value"):
    ...
    if True:#str(type(shap_values)).endswith("Explanation'>"):
