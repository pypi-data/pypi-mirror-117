...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.prop_color_polygon_facecolors = QtWidgets.QPushButton(self.groupBox_2)
        self.prop_color_polygon_facecolors.setText("")
        self.prop_color_polygon_facecolors.setObjectName("prop_color_polygon_facecolors")
        self.gridLayout_2.addWidget(self.prop_color_polygon_facecolors, 3, 1, 1, 1)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(282, 17, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_14.setText(_translate("Dialog", "alpha"))
        self.prop_check_fillsc.setText(_translate("Dialog", "Fill"))
