...
class aiqi_bluetooth_dev_mes_class:
    ...
    def __str__(self):
        restr= ('[ ' +'index:\033[0;31m' + str(self.index) + '\033[0m name: ' + str(self.name) + ' devid: ' + str(self.devid) + ' addr: ' + str
        (self.mesh_addr) + ' rssi: ' + str(self.rssi) + ']')
...
def Print_Scan_Onebot_Device(devbuf):
