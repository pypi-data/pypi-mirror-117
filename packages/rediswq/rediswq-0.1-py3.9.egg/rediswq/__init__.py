...
class RedisWQ(object):
    ...
    def __init__(self, name: str, max_retries: int = 2, **redis_kwargs) -> None:
    ...
    def _maybe_renew_job(self, job) -> None:
    ...
    def get_retry_number(self, job) -> int:
