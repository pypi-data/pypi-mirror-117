...
class Trades(KplerClient):
    ...
    def get(
        ...
        Args:
            ...
            with_product_estimation: bool By default withProductEstimation=False. Activate the product estimation feature for CPP trades only. When set to true, the estimated product will overwrite the existing product information.
        Examples:
