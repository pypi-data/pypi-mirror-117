...
setup(
    name='pinpong',
    packages=['pinpong','pinpong/base','pinpong/libs','pinpong/extension','pinpong/examples','pinpong/examples/xugu','pinpong/examples/RPi','pinpong/examples/handpy','pinpong/examples/microbit'],
