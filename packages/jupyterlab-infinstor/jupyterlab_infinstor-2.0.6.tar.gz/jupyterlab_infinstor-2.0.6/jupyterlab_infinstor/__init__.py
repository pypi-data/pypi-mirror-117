...
import datetime
from .cognito_utils import perform_infinstor_login, token_renewer, check_for_custom_token, read_token_file, get_customerinfo, setup_token_for_mlflow
...
class LoginHandler(APIHandler):  # pylint: disable=abstract-method
    ...
    def get(self, path=""):
        ...
        if (not muri):
            print('WARNING: MLFLOW_TRACKING_URI should be set')
            muri = 'infinstor:///'
