...
class window(QtWidgets.QMainWindow,Ui_MainWindow):
    def __init__(self):
        ...
        try:
            ...
            print(f'[{time.ctime()}][main/Error] error in initlazing:{e}'+colorama.Fore.RED)

            print(r'*\**:( Downloader Crashed! ):**/*'+colorama.Fore.RED)
            sys.exit(self.show())
    ...
    def download(self):
        ...
        try:
            ...
            print(f'[{time.ctime()}][main/Error] error in download:{e},ignored'+colorama.Fore.RED)
