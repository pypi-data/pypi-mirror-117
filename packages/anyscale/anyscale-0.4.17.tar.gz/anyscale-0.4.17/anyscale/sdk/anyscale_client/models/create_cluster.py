...
class CreateCluster(object):
    ...
    def __init__(self, name=None, project_id=None, cluster_environment_build_id=None, cluster_compute_id=None, idle_timeout_minutes=120, local_vars_configuration=None):  # noqa: E501
