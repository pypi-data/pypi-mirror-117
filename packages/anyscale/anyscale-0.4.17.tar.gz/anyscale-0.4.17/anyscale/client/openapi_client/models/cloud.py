...
class Cloud(object):
    ...
    def __init__(self, name=None, provider=None, region=None, credentials=None, config=None, is_k8s=False, id=None, type=None, creator_id=None, created_at=None, local_vars_configuration=None):  # noqa: E501
