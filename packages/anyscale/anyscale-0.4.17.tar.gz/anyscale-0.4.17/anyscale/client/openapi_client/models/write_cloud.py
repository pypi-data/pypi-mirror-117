...
class WriteCloud(object):
    ...
    def __init__(self, name=None, provider=None, region=None, credentials=None, config=None, is_k8s=False, creator_id=None, local_vars_configuration=None):  # noqa: E501
