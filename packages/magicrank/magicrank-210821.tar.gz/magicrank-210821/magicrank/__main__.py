...
def portfolio(args):
    ...
    prev_names = set([s['name'] for s in prev['data'] if s['rank'] < 150])
    stock_names = set([s['name'] for s in stock_list if s['rank'] < 150])
...
def main():
    ...
    parser.add_argument('--screen', dest='screen', default='290555/Investible')
