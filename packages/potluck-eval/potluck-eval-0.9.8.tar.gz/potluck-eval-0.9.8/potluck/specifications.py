...
class Check:
    ...
    def __init__(
        ...
        The identifier of the resulting goal will be based on
        substituting underscores for spaces within the name, or if no
        name is provided (in which case there must be only one pattern),
        the same substitution will be applied to the first pattern.
        """
