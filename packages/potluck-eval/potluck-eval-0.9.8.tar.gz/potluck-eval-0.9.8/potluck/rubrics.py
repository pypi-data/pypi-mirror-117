...
class Goal:
    ...
    def __init__(
        ...
        """
        You must supply an identifier (a string) and a description-tuple:
        the title of the goal, and a more detailed explanation that will
        be available if the user requests more information. The
        description-tuple may also include a third and/or fourth entry:
        these will be used instead of the first and second entry
        (respectively) when the Goal is being presented as part of graded
        feedback instead of as part of a blank rubric. This can be used
        to avoid showing exactly which tests are performed when the
        rubric is constructed, but include that information when feedback
        is given.
    ...
    def table(self, blank=False):
        ...
        - 'id': This goal's identifier, prefixed with its category tag
            followed by a period. May be absent on some rows representing
            groups of goals rather than individual goals.
        ...
        row["id"] = category + '.' + self.identifier
...
class NoteGoal(Goal):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        An identifier (a string) and a description are required, and an
        explanation (shown only during feedback, but not on the rubric)
        may also be given. By default, the feedback_only tag will be
        applied.
        ...
        super().__init__("node:" + identifier, description, **kwargs)
...
class JointGoal(Goal):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        You must provide an identifier, a description, a list of parts
        (default empty list), and a number of parts required (default is
        the size of the given parts list).
        ...
        super().__init__("joint:" + identifier, description, **kwargs)
...
class FailGoal(Goal):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        Requires an identifier and a subgoal, with optional description,
        ...
        super().__init__("fail:" + identifier, description, **kwargs)
        self.set_default_goal_type(goal_type)
...
class PreconditionGoal(Goal):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        You must provide an identifier, a description, a precondition
        goal, and a subgoal.
        ...
        super().__init__("precondition:" + identifier, description, **kwargs)
        self.set_default_goal_type(goal_type)
...
class ComparisonTest(Goal):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        In addition to an identifier (a string), a description, and
        optional explanations and/or tags (see the Goal class), a checker
        function is needed, which should accept value and reference
        objects and return a goal result (a dictionary with status +
        explanation keys). The context_slot is used to determine which
        slot in the current context to check, and ref_slot specifies
        where to get the reference object, although if not given it will
        default to "ref_" + context_slot.
        ...
        """
        super().__init__("test:" + identifier, description, **kwargs)
...
class ImplementationCheck(Goal):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        An identifier and a description is required (see the `Goal`
        class). An appropriate `test_in` dictionary which will provide a
        "scope" slot is typically required.
        ...
        super().__init__("check:" + identifier, description, **kwargs)
...
class NoParseErrors(Goal):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super().__init__("misc:no_parse_errors", description, **kwargs)
        self.set_default_goal_type("procedure")
...
class LintCheck(Goal):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        In addition to an identifier and a description, a goal type may
        be supplied other than the default "style". "procedure" is the
        ...
        # Set up Goal stuff
        super().__init__("lint:" + identifier, description, **kwargs)
...
class ExpectationsTest(Goal):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        In addition to an identifier and a description, a goal type may
        be supplied other than the default "testing".
        ...
        # Set up Goal stuff
        super().__init__("expectations:" + identifier, description, **kwargs)
...
class DefinesEnoughTests(ExpectationsTest):
    ...
    def __init__(self, reqs, **kwargs):
        """
        The main required argument is a dictionary mapping function names
        to integers specifying how many tests are required. Other
        arguments get passed through to `ExpectationsTest` and
        ...
        if "description" not in kwargs:
            kwargs["description"] = (
                (
                    "Defines tests for each core function"
                ),
                (
                    "Your code must use the <code>optimism</code> module"
                    " to establish a certain number of test cases for"
                    " each of the following functions (each test case"
                    " must be followed by at least one expectation):"
        ...
        super().__init__("defines_enough", **kwargs)
    ...
    def check(self, context):
        ...
        if not any_tests:
            ...
            return {
                "status": "partial",
                "explanation": (
                    "Your module did not establish as many test cases"
                    " as were required for all functions:\n"
...
class TestsPassedInSubmission(ExpectationsTest):
    ...
    def __init__(self, **kwargs):
        """
        Arguments are passed through to `ExpectationsTest`.
        ...
        super().__init__("met_in_submission", **kwargs)
...
class TestsPassForSolution(ExpectationsTest):
    ...
    def __init__(self, targets, **kwargs):
        """
        A list of function names to target is required. Additional
        arguments are passed through to `ExpectationsTest`.
        ...
        super().__init__("met_in_solution", **kwargs)
