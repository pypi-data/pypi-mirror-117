...
class DLDSClient:
    ...
    def get_dataset_items(self, dataset_id: int,
    ...
    def download_dataset_item(self, item_id, image_dir: Optional[str] = None, annotation_dir: Optional[str] = None,
        ...
        :return:
        """
        if image_dir is None and annotation_dir is None and not return_item:
