...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, pulp_href=None, name=None, retained_versions=None, versions_href=None, pulp_labels=None, pulp_created=None, description=None, local_vars_configuration=None):  # noqa: E501
