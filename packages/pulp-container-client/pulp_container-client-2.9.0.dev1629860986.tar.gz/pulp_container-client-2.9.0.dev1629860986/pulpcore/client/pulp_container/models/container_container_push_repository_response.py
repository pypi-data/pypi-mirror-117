...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, latest_version_href=None, pulp_labels=None, versions_href=None, description=None, retained_versions=None, pulp_href=None, name=None, local_vars_configuration=None):  # noqa: E501
