...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_labels=None, base_path=None, content_guard=None, repository=None, pulp_href=None, name=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
