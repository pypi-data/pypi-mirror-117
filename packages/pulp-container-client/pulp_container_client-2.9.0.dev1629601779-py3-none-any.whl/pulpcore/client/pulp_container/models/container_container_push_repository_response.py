...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_href=None, versions_href=None, latest_version_href=None, description=None, pulp_labels=None, retained_versions=None, pulp_created=None, name=None, local_vars_configuration=None):  # noqa: E501
