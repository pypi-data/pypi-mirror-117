...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retained_versions=None, pulp_href=None, pulp_labels=None, pulp_created=None, versions_href=None, name=None, description=None, latest_version_href=None, local_vars_configuration=None):  # noqa: E501
