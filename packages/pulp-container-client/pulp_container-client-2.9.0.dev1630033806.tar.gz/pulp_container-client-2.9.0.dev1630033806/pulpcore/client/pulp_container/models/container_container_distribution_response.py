...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, pulp_href=None, pulp_labels=None, pulp_created=None, name=None, repository=None, content_guard=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
