...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, retained_versions=None, pulp_href=None, pulp_created=None, pulp_labels=None, description=None, versions_href=None, latest_version_href=None, local_vars_configuration=None):  # noqa: E501
