...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, versions_href=None, pulp_created=None, pulp_labels=None, pulp_href=None, name=None, description=None, retained_versions=None, latest_version_href=None, local_vars_configuration=None):  # noqa: E501
