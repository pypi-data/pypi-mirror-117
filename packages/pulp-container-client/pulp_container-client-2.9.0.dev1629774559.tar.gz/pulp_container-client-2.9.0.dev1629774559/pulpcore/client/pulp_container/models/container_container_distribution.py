...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, base_path=None, repository=None, pulp_labels=None, name=None, content_guard=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
