...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, name=None, pulp_href=None, pulp_labels=None, pulp_created=None, description=None, versions_href=None, retained_versions=None, local_vars_configuration=None):  # noqa: E501
