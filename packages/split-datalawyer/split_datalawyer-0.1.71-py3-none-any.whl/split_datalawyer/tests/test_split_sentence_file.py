...
for file in files:
    if file == 'example4.txt':
        ...
        sentences = sentence_split.get_sentences(content, remove_duplicated=False, split_by_semicolon=False,
                                                 split_parenthesis_ending=True, split_by_hyphens=False,
                                                 limit=300)
        print(sentences)
