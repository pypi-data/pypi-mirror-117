...
class RetrieveRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"cases",b"cases",u"nlp_config",b"nlp_config",u"query",b"query",u"query_graph",b"query_graph",u"query_text",b"query_text"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"query",b"query"]) -> typing_extensions.Literal["query_graph","query_text"]: ...
