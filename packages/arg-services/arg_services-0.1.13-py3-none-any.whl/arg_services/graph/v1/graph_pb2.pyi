...
class Resource(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"timestamp",b"timestamp",u"userdata",b"userdata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"source",b"source",u"text",b"text",u"timestamp",b"timestamp",u"title",b"title",u"userdata",b"userdata"]) -> None: ...
...
class Node(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"node",b"node"]) -> typing_extensions.Literal["atom","scheme"]: ...
global___Node = Node
